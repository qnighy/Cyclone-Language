...
# 144
struct _fat_ptr Cyc_PP_nlblanks(int i){struct Cyc_Core_Opt*_T0;struct Cyc_Hashtable_Table*(*_T1)(int,int(*)(int,int),int(*)(int));struct Cyc_Hashtable_Table*(*_T2)(int,int(*)(void*,void*),int(*)(void*));int(*_T3)(int,int);int(*_T4)(int);void*(*_T5)(void*);struct Cyc_Core_Failure_exn_struct*_T6;void*_T7;struct _handler_cons*_T8;int _T9;struct _fat_ptr*(*_TA)(struct Cyc_Hashtable_Table*,int);void*(*_TB)(struct Cyc_Hashtable_Table*,void*);struct Cyc_Core_Opt*_TC;void*_TD;struct Cyc_Hashtable_Table*_TE;int _TF;struct _fat_ptr*_T10;void*_T11;struct Cyc_Core_Not_found_exn_struct*_T12;char*_T13;char*_T14;int _T15;int _T16;int _T17;int _T18;unsigned _T19;struct _fat_ptr _T1A;unsigned char*_T1B;char*_T1C;unsigned long _T1D;unsigned char*_T1E;char*_T1F;struct _fat_ptr _T20;int _T21;unsigned char*_T22;char*_T23;unsigned long _T24;unsigned char*_T25;char*_T26;struct _fat_ptr _T27;int _T28;int _T29;int _T2A;unsigned char*_T2B;char*_T2C;unsigned long _T2D;unsigned char*_T2E;char*_T2F;void(*_T30)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*);void(*_T31)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Core_Opt*_T32;void*_T33;struct Cyc_Hashtable_Table*_T34;int _T35;struct _fat_ptr*_T36;struct _fat_ptr*_T37;unsigned long _T38;struct _fat_ptr _T39;struct _fat_ptr _T3A;int _T3B;unsigned _T3C;struct _fat_ptr _T3D;unsigned char*_T3E;char*_T3F;char*_T40;unsigned long _T41;unsigned char*_T42;char*_T43;struct _fat_ptr _T44;unsigned char*_T45;char*_T46;unsigned long _T47;unsigned char*_T48;char*_T49;struct _fat_ptr _T4A;unsigned char*_T4B;char*_T4C;unsigned long _T4D;unsigned char*_T4E;char*_T4F;struct _fat_ptr _T50;int _T51;unsigned char*_T52;char*_T53;unsigned long _T54;unsigned char*_T55;char*_T56;void(*_T57)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*);void(*_T58)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Core_Opt*_T59;void*_T5A;struct Cyc_Hashtable_Table*_T5B;int _T5C;struct _fat_ptr*_T5D;struct _fat_ptr*_T5E;unsigned long _T5F;struct _fat_ptr _T60;struct _fat_ptr _T61;
...
# 186
static struct Cyc_PP_Out*Cyc_PP_text_doc_f(struct _tuple2*clo,struct Cyc_PP_Ppstate*st){struct _tuple2*_T0;struct Cyc_PP_Out*_T1;struct Cyc_PP_Ppstate*_T2;int _T3;int _T4;struct Cyc_PP_Ppstate*_T5;struct Cyc_PP_Single_PP_Alist_struct*_T6;struct _fat_ptr*_T7;struct _fat_ptr*_T8;unsigned long _T9;struct Cyc_PP_Empty_PP_Alist_struct*_TA;struct Cyc_PP_Empty_PP_Alist_struct*_TB;struct _fat_ptr _TC;int _TD;_T0=clo;{struct _tuple2 _TE=*_T0;_TD=_TE.f0;_TC=_TE.f1;}{int slen=_TD;struct _fat_ptr s=_TC;{struct Cyc_PP_Out*_TE=_cycalloc(sizeof(struct Cyc_PP_Out));_T2=st;_T3=_T2->cc;_T4=slen;
# 188
_TE->newcc=_T3 + _T4;_T5=st;
_TE->newcl=_T5->cl;{struct Cyc_PP_Single_PP_Alist_struct*_TF=_cycalloc(sizeof(struct Cyc_PP_Single_PP_Alist_struct));_TF->tag=1;{unsigned long _T10=1;_T9=_check_times(_T10,sizeof(struct _fat_ptr));{struct _fat_ptr*_T11=_cycalloc(_T9);
...
# 270
static struct Cyc_PP_Out*Cyc_PP_hyperlink_f(struct _tuple3*clo,struct Cyc_PP_Ppstate*st){struct _tuple3*_T0;struct Cyc_PP_Out*_T1;struct Cyc_PP_Ppstate*_T2;int _T3;int _T4;struct Cyc_PP_Ppstate*_T5;struct Cyc_PP_Single_PP_Alist_struct*_T6;struct _fat_ptr*_T7;struct _fat_ptr*_T8;unsigned long _T9;struct Cyc_PP_Single_PP_Alist_struct*_TA;struct _tuple4*_TB;struct Cyc_PP_Ppstate*_TC;struct Cyc_PP_Ppstate*_TD;struct _fat_ptr _TE;struct _fat_ptr _TF;int _T10;_T0=clo;{struct _tuple3 _T11=*_T0;_T10=_T11.f0;_TF=_T11.f1;_TE=_T11.f2;}{int slen=_T10;struct _fat_ptr shrt=_TF;struct _fat_ptr full=_TE;{struct Cyc_PP_Out*_T11=_cycalloc(sizeof(struct Cyc_PP_Out));_T2=st;_T3=_T2->cc;_T4=slen;
# 272
_T11->newcc=_T3 + _T4;_T5=st;
_T11->newcl=_T5->cl;{struct Cyc_PP_Single_PP_Alist_struct*_T12=_cycalloc(sizeof(struct Cyc_PP_Single_PP_Alist_struct));_T12->tag=1;{unsigned long _T13=1;_T9=_check_times(_T13,sizeof(struct _fat_ptr));{struct _fat_ptr*_T14=_cycalloc(_T9);
...
return _T1;}}
# 285
static struct Cyc_PP_Out*Cyc_PP_line_f(struct Cyc_PP_Ppstate*st){struct Cyc_PP_Out*_T0;struct Cyc_PP_Ppstate*_T1;struct Cyc_PP_Ppstate*_T2;int _T3;struct Cyc_PP_Single_PP_Alist_struct*_T4;struct _fat_ptr*_T5;struct _fat_ptr*_T6;unsigned long _T7;struct Cyc_PP_Ppstate*_T8;int _T9;struct Cyc_PP_Empty_PP_Alist_struct*_TA;struct Cyc_PP_Empty_PP_Alist_struct*_TB;{struct Cyc_PP_Out*_TC=_cycalloc(sizeof(struct Cyc_PP_Out));_T1=st;
_TC->newcc=_T1->ci;_T2=st;_T3=_T2->cl;
_TC->newcl=_T3 + 1;{struct Cyc_PP_Single_PP_Alist_struct*_TD=_cycalloc(sizeof(struct Cyc_PP_Single_PP_Alist_struct));_TD->tag=1;{unsigned long _TE=1;_T7=_check_times(_TE,sizeof(struct _fat_ptr));{struct _fat_ptr*_TF=_cycalloc(_T7);_T8=st;_T9=_T8->ci;
...
return _T0;}
# 343
struct Cyc_PP_Doc*Cyc_PP_cat(struct _fat_ptr l){struct _fat_ptr _T0;unsigned long _T1;unsigned long _T2;struct _fat_ptr _T3;int _T4;unsigned char*_T5;struct Cyc_PP_Doc**_T6;struct Cyc_PP_Doc*_T7;struct Cyc_PP_Doc*_T8;struct Cyc_PP_Doc*_T9;
...
# 419
struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _fat_ptr docs){struct _fat_ptr _T0;unsigned long _T1;struct Cyc_Core_Failure_exn_struct*_T2;void*_T3;struct _fat_ptr _T4;unsigned char*_T5;struct Cyc_PP_Doc**_T6;struct Cyc_PP_Doc**_T7;struct Cyc_PP_Doc*_T8;struct Cyc_PP_Doc*_T9;int _TA;int _TB;struct _fat_ptr _TC;int _TD;unsigned char*_TE;struct Cyc_PP_Doc**_TF;struct Cyc_PP_Doc*_T10;int _T11;int _T12;int _T13;int _T14;struct _fat_ptr _T15;unsigned char*_T16;struct Cyc_PP_Doc**_T17;int _T18;struct Cyc_PP_Doc*_T19;int _T1A;int _T1B;struct Cyc_PP_Doc*_T1C;struct Cyc_Fn_Function*(*_T1D)(struct Cyc_PP_Out*(*)(struct _fat_ptr*,struct Cyc_PP_Ppstate*),struct _fat_ptr*);struct Cyc_Fn_Function*(*_T1E)(void*(*)(void*,void*),void*);struct _fat_ptr*_T1F;struct _fat_ptr*_T20;unsigned long _T21;_T0=docs;_T1=
