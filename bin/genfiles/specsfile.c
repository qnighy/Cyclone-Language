...
int i;
char strname[256U];
char strvalue[65536U];_T0=file;_T1=_untag_fat_ptr_check_bound(_T0,sizeof(char),1U);_T2=_check_null(_T1);_T3=(const char*)_T2;{
...
if(_T30==_T31)goto _TL25;else{goto _TL27;}_TL27: if(c==10)goto _TL25;else{goto _TL26;}_TL26: if(c==13)goto _TL25;else{goto _TL23;}_TL25: _T32=strvalue;_T33=i;_T34=_check_known_subscript_notnull(_T32,65536U,sizeof(char),_T33);_T35=(char*)_T34;*_T35='\000';goto _TL22;_TL23: _T36=strvalue;_T37=i;_T38=_check_known_subscript_notnull(_T36,65536U,sizeof(char),_T37);_T39=(char*)_T38;_T3A=c;
*_T39=(char)_T3A;
i=i + 1;
if(i < 65536)goto _TL28;{struct Cyc_String_pa_PrintArg_struct _T4E;_T4E.tag=0;
# 131
...
_tag_fat(_T48,sizeof(char),65536U);_T4A=Cyc_strdup(_T49);*_T50=_T4A;_T47=(struct _fat_ptr*)_T50;}_T4F->f1=_T47;_T42=(struct _tuple0*)_T4F;}
# 137
_T4E->hd=_T42;
...
int i=0;
int j=0;
if(n <= 65536U)goto _TL2E;goto DONE;_TL2E:
...
if(_T32!=0)goto _TL4A;goto _TL3F;_TL4A: _T33=buf;_T34=j;_T35=_check_known_subscript_notnull(_T33,65536U,sizeof(char),_T34);_T36=(char*)_T35;_T37=cmdline;_T38=_T37.curr;_T39=(const char*)_T38;_T3A=i;
*_T36=_T39[_T3A];
j=j + 1;goto _TL47;
# 182
_TL46: _T3B=buf;_T3C=j;_T3D=_check_known_subscript_notnull(_T3B,65536U,sizeof(char),_T3C);_T3E=(char*)_T3D;_T3F=cmdline;_T40=_T3F.curr;_T41=(const char*)_T40;_T42=i;*_T3E=_T41[_T42];
j=j + 1;_TL47:
# 185
 i=i + 1;goto _TL3D;_TL3F:
# 187
 if(j >= 65536)goto _TL4C;_T43=buf;_T44=j;_T45=_check_known_subscript_notnull(_T43,65536U,sizeof(char),_T44);_T46=(char*)_T45;
...
# 190
_tag_fat(_T49,sizeof(char),65536U);_T4B=Cyc_strdup(_T4A);*_T5C=_T4B;_T48=(struct _fat_ptr*)_T5C;}_T5B->hd=_T48;_T5B->tl=l;_T47=(struct Cyc_List_List*)_T5B;}l=_T47;goto _TL30;_TL32:
# 192
 DONE:
...
return _TC;}
# 236 "specsfile.cyc"
struct _fat_ptr Cyc_Specsfile_parse_b(struct Cyc_List_List*specs,void(*anonfun)(struct _fat_ptr),int(*anonflagfun)(struct _fat_ptr),struct _fat_ptr errmsg,struct _fat_ptr argv){struct _fat_ptr _T0;unsigned long _T1;struct _fat_ptr _T2;int _T3;int*_T4;unsigned long _T5;unsigned long _T6;struct _fat_ptr _T7;struct _fat_ptr _T8;int _T9;unsigned char*_TA;struct _fat_ptr*_TB;struct _fat_ptr _TC;int _TD;struct _fat_ptr _TE;unsigned char*_TF;int*_T10;int _T11;struct _fat_ptr _T12;struct _fat_ptr _T13;unsigned char*_T14;struct _fat_ptr*_T15;int _T16;struct _fat_ptr _T17;int _T18;struct _fat_ptr _T19;unsigned char*_T1A;int*_T1B;int _T1C;struct _fat_ptr _T1D;int _T1E;unsigned char*_T1F;int*_T20;struct _fat_ptr _T21;int _T22;struct _fat_ptr*_T23;unsigned long _T24;unsigned long _T25;struct _fat_ptr _T26;struct _fat_ptr _T27;int _T28;struct _fat_ptr*_T29;unsigned long _T2A;unsigned long _T2B;struct _fat_ptr _T2C;struct _fat_ptr _T2D;unsigned char*_T2E;struct _fat_ptr*_T2F;struct _fat_ptr _T30;unsigned char*_T31;struct _fat_ptr*_T32;struct _fat_ptr _T33;unsigned char*_T34;struct _fat_ptr*_T35;struct _fat_ptr _T36;int _T37;unsigned char*_T38;int*_T39;int _T3A;struct _fat_ptr _T3B;int _T3C;int _T3D;unsigned char*_T3E;struct _fat_ptr*_T3F;struct _fat_ptr _T40;unsigned char*_T41;struct _fat_ptr*_T42;int _T43;struct _fat_ptr _T44;int _T45;int _T46;unsigned char*_T47;struct _fat_ptr*_T48;struct _fat_ptr _T49;unsigned char*_T4A;struct _fat_ptr*_T4B;int _T4C;struct Cyc_List_List*_T4D;void(*_T4E)(struct _fat_ptr);int(*_T4F)(struct _fat_ptr);struct _fat_ptr _T50;struct _fat_ptr _T51;struct _fat_ptr _T52;unsigned char*_T53;char*_T54;struct _fat_ptr _T55;void*_T56;void*_T57;unsigned long _T58;struct _fat_ptr _T59;void*_T5A;void*_T5B;unsigned long _T5C;struct _fat_ptr _T5D;unsigned char*_T5E;char*_T5F;struct Cyc_List_List*_T60;struct _fat_ptr*_T61;struct _fat_ptr _T62;void*_T63;void*_T64;unsigned long _T65;unsigned long _T66;struct Cyc_List_List*_T67;struct _fat_ptr*_T68;struct _fat_ptr _T69;struct _fat_ptr _T6A;struct _fat_ptr _T6B;struct _fat_ptr _T6C;_T0=argv;_T1=
# 244
_get_fat_size(_T0,sizeof(struct _fat_ptr));{int argc=(int)_T1;_T3=argc;{unsigned long _T6D=(unsigned long)_T3;_T5=_check_times(_T6D,sizeof(int));{int*_T6E=_cycalloc_atomic(_T5);{unsigned long _T6F=_T6D;unsigned long i;i=0;_TL60: if(i < _T6F)goto _TL5E;else{goto _TL5F;}_TL5E: _T6=i;
...
# 248
 i=i + 1;goto _TL64;_TL63: _T22=numbindices + 1;{unsigned long _T6D=(unsigned long)_T22;_T24=_check_times(_T6D,sizeof(struct _fat_ptr));{struct _fat_ptr*_T6E=_cycalloc(_T24);{unsigned long _T6F=_T6D;unsigned long n;n=0;_TL6E: if(n < _T6F)goto _TL6C;else{goto _TL6D;}_TL6C: _T25=n;_T26=
# 265
_tag_fat(0,0,0);_T6E[_T25]=_T26;n=n + 1;goto _TL6E;_TL6D:;}_T23=(struct _fat_ptr*)_T6E;}_T21=_tag_fat(_T23,sizeof(struct _fat_ptr),_T6D);}{struct _fat_ptr bargs=_T21;_T28=argc - numbindices;{unsigned long _T6D=(unsigned long)_T28;_T2A=_check_times(_T6D,sizeof(struct _fat_ptr));{struct _fat_ptr*_T6E=_cycalloc(_T2A);{unsigned long _T6F=_T6D;unsigned long n;n=0;_TL72: if(n < _T6F)goto _TL70;else{goto _TL71;}_TL70: _T2B=n;_T2C=
