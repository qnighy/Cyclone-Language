...
# 33
struct _fat_ptr Cyc_Interproc_make_parg(struct _fat_ptr ap){struct _fat_ptr _T0;struct _fat_ptr _T1;void**_T2;unsigned _T3;unsigned _T4;struct _fat_ptr _T5;unsigned char*_T6;void**_T7;void**_T8;unsigned _T9;int _TA;struct _fat_ptr _TB;_T1=ap;{unsigned _TC=
_get_fat_size(_T1,sizeof(void*));_T3=_check_times(_TC,sizeof(void*));{void**_TD=_cycalloc(_T3);{unsigned _TE=_TC;unsigned i;i=0;_TL3: if(i < _TE)goto _TL1;else{goto _TL2;}_TL1: _T4=i;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=_check_null(_T7);_T9=i;_TA=(int)_T9;_TD[_T4]=_T8[_TA];i=i + 1;goto _TL3;_TL2:;}_T2=(void**)_TD;}_T0=_tag_fat(_T2,sizeof(void*),_TC);}{struct _fat_ptr ret=_T0;_TB=ret;
return _TB;}}
# 38
