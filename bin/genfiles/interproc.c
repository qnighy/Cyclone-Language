...
# 33
struct _fat_ptr Cyc_Interproc_make_parg(struct _fat_ptr ap){struct _fat_ptr _T0;struct _fat_ptr _T1;void**_T2;unsigned long _T3;unsigned long _T4;struct _fat_ptr _T5;unsigned char*_T6;void**_T7;void**_T8;unsigned long _T9;int _TA;struct _fat_ptr _TB;_T1=ap;{unsigned long _TC=
_get_fat_size(_T1,sizeof(void*));_T3=_check_times(_TC,sizeof(void*));{void**_TD=_cycalloc(_T3);{unsigned long _TE=_TC;unsigned long i;i=0;_TL3: if(i < _TE)goto _TL1;else{goto _TL2;}_TL1: _T4=i;_T5=ap;_T6=_T5.curr;_T7=(void**)_T6;_T8=_check_null(_T7);_T9=i;_TA=(int)_T9;_TD[_T4]=_T8[_TA];i=i + 1;goto _TL3;_TL2:;}_T2=(void**)_TD;}_T0=_tag_fat(_T2,sizeof(void*),_TC);}{struct _fat_ptr ret=_T0;_TB=ret;
return _TB;}}
# 38
...
return _T7;}}
# 76
static void Cyc_Interproc_dump_decl_tags(struct Cyc_List_List*ns,struct _fat_ptr sourcefile,struct Cyc_List_List*tds){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_Absyn_Decl*_T4;int*_T5;unsigned _T6;struct Cyc_String_pa_PrintArg_struct _T7;struct Cyc_String_pa_PrintArg_struct _T8;struct Cyc_Absyn_Fndecl*_T9;struct _tuple0*_TA;struct Cyc_String_pa_PrintArg_struct _TB;struct Cyc___cycFILE*_TC;struct _fat_ptr _TD;struct _fat_ptr _TE;struct Cyc_List_List*_TF;struct Cyc_List_List*_T10;struct Cyc_List_List*_T11;struct _fat_ptr _T12;struct Cyc_List_List*_T13;struct Cyc_List_List*_T14;
_TL10: _T0=tds;_T1=(unsigned long)_T0;if(_T1)goto _TLE;else{goto _TLF;}
...
# 97
void Cyc_Interproc_dump_tags(struct _fat_ptr sourcefile,struct Cyc_List_List*tds){struct Cyc___cycFILE*_T0;unsigned long _T1;struct _fat_ptr _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct Cyc___cycFILE*_T5;unsigned long _T6;struct _fat_ptr _T7;struct _fat_ptr _T8;_T0=Cyc_Interproc_tagsFile;_T1=(unsigned long)_T0;
if(_T1)goto _TL12;else{goto _TL14;}
_TL14: _T2=_tag_fat("CYCTAGS",sizeof(char),8U);_T3=_tag_fat("w",sizeof(char),2U);_T4=_tag_fat("CYCTAGS",sizeof(char),8U);Cyc_Interproc_tagsFile=Cyc_Interproc_try_file_open(_T2,_T3,_T4);_T5=Cyc_Interproc_tagsFile;_T6=(unsigned long)_T5;
...
# 107
void Cyc_Interproc_close_tags_file (void){struct Cyc___cycFILE*_T0;unsigned long _T1;_T0=Cyc_Interproc_tagsFile;_T1=(unsigned long)_T0;
if(!_T1)goto _TL18;
...
# 119
static void Cyc_Interproc_print_filedecls(struct Cyc_List_List*fd){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_String_pa_PrintArg_struct _T2;struct Cyc_List_List*_T3;void*_T4;struct _tuple11*_T5;struct Cyc___cycFILE*_T6;struct _fat_ptr _T7;struct _fat_ptr _T8;struct Cyc_List_List*_T9;
_TL1D: _T0=fd;_T1=(unsigned long)_T0;if(_T1)goto _TL1B;else{goto _TL1C;}
...
# 181
 return 1;}
# 185
static int Cyc_Interproc_init_tagmap(struct Cyc_List_List*ftds){struct Cyc_Hashtable_Table*_T0;unsigned long _T1;struct _fat_ptr _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct Cyc___cycFILE*_T5;unsigned long _T6;struct Cyc_List_List*_T7;unsigned long _T8;struct Cyc_Hashtable_Table*(*_T9)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*));struct Cyc_Hashtable_Table*(*_TA)(int,int(*)(void*,void*),int(*)(void*));struct _fat_ptr*_TB;struct _fat_ptr _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct Cyc_List_List*_TE;void*_TF;struct _tuple11*_T10;struct _fat_ptr _T11;struct _fat_ptr _T12;struct Cyc_List_List*_T13;void*_T14;struct _tuple11*_T15;struct Cyc_List_List*_T16;int _T17;struct Cyc_Hashtable_Table*(*_T18)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*));struct Cyc_Hashtable_Table*(*_T19)(int,int(*)(void*,void*),int(*)(void*));struct _fat_ptr _T1A;unsigned char*_T1B;unsigned long _T1C;struct _fat_ptr _T1D;unsigned char*_T1E;char*_T1F;char _T20;int _T21;struct _fat_ptr*_T22;struct _fat_ptr _T23;struct Cyc_String_pa_PrintArg_struct _T24;struct _fat_ptr _T25;struct _fat_ptr _T26;struct _fat_ptr _T27;struct _fat_ptr _T28;struct _fat_ptr*_T29;struct _fat_ptr _T2A;struct Cyc_String_pa_PrintArg_struct _T2B;struct _fat_ptr _T2C;struct _fat_ptr _T2D;struct _fat_ptr _T2E;struct _fat_ptr _T2F;struct _fat_ptr _T30;struct _fat_ptr _T31;struct _fat_ptr _T32;struct _fat_ptr _T33;int _T34;void(*_T35)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,struct _fat_ptr*);void(*_T36)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Hashtable_Table*_T37;struct _fat_ptr*_T38;struct _fat_ptr*_T39;_T0=Cyc_Interproc_tagmap;_T1=(unsigned long)_T0;
if(!_T1)goto _TL33;
return 1;_TL33: _T2=
_tag_fat("CYCTAGS",sizeof(char),8U);_T3=_tag_fat("r",sizeof(char),2U);_T4=_tag_fat("CYCTAGS",sizeof(char),8U);{struct Cyc___cycFILE*tags=Cyc_Interproc_try_file_open(_T2,_T3,_T4);_T5=tags;_T6=(unsigned long)_T5;
if(_T6)goto _TL35;else{goto _TL37;}
_TL37: _T7=ftds;_T8=(unsigned long)_T7;if(_T8)goto _TL38;else{goto _TL3A;}
...
_TL3B: line=Cyc_Interproc_grabline(tags);_T1A=line;_T1B=_T1A.curr;_T1C=(unsigned long)_T1B;if(_T1C)goto _TL3C;else{goto _TL3D;}
...
return 1;}}}
# 214
static struct _fat_ptr Cyc_Interproc_locate_qvar(struct _tuple0*qv,struct Cyc_List_List*ftds){struct Cyc_Hashtable_Table*_T0;unsigned long _T1;int _T2;struct Cyc_Core_Not_found_exn_struct*_T3;struct Cyc_Core_Not_found_exn_struct*_T4;struct _fat_ptr*_T5;struct _fat_ptr _T6;struct Cyc_String_pa_PrintArg_struct _T7;struct _fat_ptr _T8;struct _fat_ptr _T9;struct _fat_ptr*(*_TA)(struct Cyc_Hashtable_Table*,struct _fat_ptr*);void*(*_TB)(struct Cyc_Hashtable_Table*,void*);struct Cyc_Hashtable_Table*_TC;struct _fat_ptr*_TD;struct _fat_ptr*_TE;struct _fat_ptr _TF;_T0=Cyc_Interproc_tagmap;_T1=(unsigned long)_T0;
...
# 233
static struct _tuple13 Cyc_Interproc_add_filedecls(struct _fat_ptr filename,struct Cyc_List_List*ftds){int(*_T0)(int(*)(struct _fat_ptr*,struct _tuple11*),struct _fat_ptr*,struct Cyc_List_List*);int(*_T1)(int(*)(void*,void*),void*,struct Cyc_List_List*);int(*_T2)(struct _fat_ptr*,struct _tuple11*);struct _fat_ptr*_T3;struct _fat_ptr*_T4;struct Cyc_List_List*_T5;int _T6;struct _tuple13 _T7;struct Cyc_List_List*_T8;unsigned long _T9;struct _tuple13 _TA;struct Cyc_List_List*_TB;struct _tuple11*_TC;struct Cyc_List_List*_TD;struct _tuple13 _TE;_T1=Cyc_List_exists_c;{
...
struct Cyc_List_List*decls=Cyc_Cyclone_parse_file(filename);_T8=decls;_T9=(unsigned long)_T8;
...
_TL6D:{struct _tuple14 _T54;_T54.f0=0;_T54.f1=0;_T54.f2=0;_T4C=_T54;}return _T4C;_TL6B: _T4D=newdecls;_T4E=(unsigned long)_T4D;
...
# 345
static void Cyc_Interproc_remove_cvars(void*t){void*_T0;int*_T1;unsigned _T2;void*_T3;struct Cyc_Absyn_PtrInfo _T4;void*_T5;struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T6;void**_T7;void**_T8;void*_T9;int _TA;void**_TB;void*_TC;void*_TD;struct Cyc_Absyn_FnType_Absyn_Type_struct*_TE;struct Cyc_Absyn_FnInfo*_TF;struct Cyc_Absyn_FnInfo*_T10;void*_T11;struct Cyc_Absyn_FnInfo*_T12;struct Cyc_List_List*_T13;unsigned long _T14;struct Cyc_List_List*_T15;void*_T16;struct _tuple8*_T17;void*_T18;struct Cyc_List_List*_T19;void*_T1A;void*_T1B;struct Cyc_List_List*_T1C;unsigned long _T1D;struct Cyc_List_List*_T1E;void*_T1F;struct Cyc_List_List*_T20;void*_T21;struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T22;int _T23;void*_T24;struct Cyc_List_List*_T25;unsigned long _T26;struct Cyc_List_List*_T27;void*_T28;struct Cyc_Absyn_Aggrfield*_T29;void*_T2A;struct Cyc_List_List*_T2B;struct Cyc_List_List*_T2C;void*_T2D;void*_T2E;_T0=t;_T1=(int*)_T0;_T2=*_T1;switch(_T2){case 4: _T3=t;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T2F=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3;_T4=_T2F->f1;_T2E=_T4.elt_type;_T5=t;_T6=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T5;_T7=& _T6->f1.ptr_atts.bounds;_T2D=(void**)_T7;}{void*ta=_T2E;void**b=(void**)_T2D;_T8=b;_T9=*_T8;_TA=
# 348
...
struct Cyc_List_List*args=_T12->args;_TL7C: _T13=args;_T14=(unsigned long)_T13;if(_T14)goto _TL7A;else{goto _TL7B;}
...
# 361
_TL80: _T1C=ts;_T1D=(unsigned long)_T1C;if(_T1D)goto _TL7E;else{goto _TL7F;}_TL7E: _T1E=ts;_T1F=_T1E->hd;Cyc_Interproc_remove_cvars(_T1F);_T20=ts;ts=_T20->tl;goto _TL80;_TL7F:
...
# 364
_TL86: _T25=fields;_T26=(unsigned long)_T25;if(_T26)goto _TL84;else{goto _TL85;}
...
# 374
static void Cyc_Interproc_ensure_cvar_identity(unsigned loc,void*dest,void*src){struct _tuple15 _T0;void*_T1;int*_T2;unsigned _T3;void*_T4;int*_T5;int _T6;void*_T7;struct Cyc_Absyn_PtrInfo _T8;void*_T9;struct Cyc_Absyn_PointerType_Absyn_Type_struct*_TA;void**_TB;void*_TC;struct Cyc_Absyn_PtrInfo _TD;void*_TE;struct Cyc_Absyn_PointerType_Absyn_Type_struct*_TF;void**_T10;void**_T11;void*_T12;int _T13;void**_T14;void**_T15;void*_T16;int*_T17;int _T18;void*_T19;void*_T1A;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T1B;struct Cyc_Absyn_FnInfo*_T1C;void*_T1D;void*_T1E;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T1F;struct Cyc_Absyn_FnInfo*_T20;unsigned _T21;struct Cyc_Absyn_FnInfo*_T22;void*_T23;struct Cyc_Absyn_FnInfo*_T24;void*_T25;struct Cyc_Absyn_FnInfo*_T26;struct Cyc_List_List*_T27;int _T28;struct Cyc_Absyn_FnInfo*_T29;struct Cyc_List_List*_T2A;int _T2B;struct Cyc_Interproc_Rebinding_exn_struct*_T2C;struct Cyc_Interproc_Rebinding_exn_struct*_T2D;struct Cyc_Absyn_FnInfo*_T2E;struct Cyc_Absyn_FnInfo*_T2F;struct Cyc_List_List*_T30;unsigned long _T31;struct Cyc_List_List*_T32;unsigned long _T33;unsigned _T34;struct Cyc_List_List*_T35;void*_T36;struct _tuple8*_T37;void*_T38;struct Cyc_List_List*_T39;void*_T3A;struct _tuple8*_T3B;void*_T3C;struct Cyc_List_List*_T3D;struct Cyc_List_List*_T3E;void*_T3F;int*_T40;int _T41;void*_T42;void*_T43;int _T44;int _T45;struct Cyc_Warn_String_Warn_Warg_struct _T46;struct Cyc_Warn_Typ_Warn_Warg_struct _T47;unsigned _T48;struct _fat_ptr _T49;struct Cyc_List_List*_T4A;unsigned long _T4B;struct Cyc_List_List*_T4C;void*_T4D;struct Cyc_List_List*_T4E;void*_T4F;int*_T50;int _T51;void*_T52;void*_T53;int _T54;int _T55;struct Cyc_Interproc_Rebinding_exn_struct*_T56;struct Cyc_Interproc_Rebinding_exn_struct*_T57;struct Cyc_List_List*_T58;unsigned long _T59;struct Cyc_List_List*_T5A;unsigned long _T5B;unsigned _T5C;struct Cyc_List_List*_T5D;void*_T5E;struct Cyc_List_List*_T5F;void*_T60;struct Cyc_List_List*_T61;struct Cyc_List_List*_T62;void*_T63;struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T64;int _T65;void*_T66;int*_T67;int _T68;void*_T69;struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T6A;int _T6B;void*_T6C;void*_T6D;int _T6E;int _T6F;struct Cyc_Interproc_Rebinding_exn_struct*_T70;struct Cyc_Interproc_Rebinding_exn_struct*_T71;struct Cyc_List_List*_T72;unsigned long _T73;struct Cyc_List_List*_T74;unsigned long _T75;unsigned _T76;struct Cyc_List_List*_T77;void*_T78;struct Cyc_Absyn_Aggrfield*_T79;void*_T7A;struct Cyc_List_List*_T7B;void*_T7C;struct Cyc_Absyn_Aggrfield*_T7D;void*_T7E;struct Cyc_List_List*_T7F;struct Cyc_List_List*_T80;{struct _tuple15 _T81;
...
_TL93: _T30=argD;_T31=(unsigned long)_T30;
# 385
if(_T31)goto _TL94;else{goto _TL92;}_TL94: _T32=argS;_T33=(unsigned long)_T32;if(_T33)goto _TL91;else{goto _TL92;}
# 387
...
_TL9C: _T4A=tS;_T4B=(unsigned long)_T4A;if(_T4B)goto _TL9A;else{goto _TL9B;}
...
# 405
 _TLA4: _T58=tD;_T59=(unsigned long)_T58;if(_T59)goto _TLA5;else{goto _TLA3;}_TLA5: _T5A=tS;_T5B=(unsigned long)_T5A;if(_T5B)goto _TLA2;else{goto _TLA3;}
...
# 411
 _TLB1: _T72=fieldD;_T73=(unsigned long)_T72;if(_T73)goto _TLB2;else{goto _TLB0;}_TLB2: _T74=fieldS;_T75=(unsigned long)_T74;if(_T75)goto _TLAF;else{goto _TLB0;}
...
# 508
void**(*_T20F)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*))=(void**(*)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*)))_T2B;_T2A=_T20F;}_T2C=cvmap;_T2D=& nn;_T2E=(struct _fat_ptr*)_T2D;_T2F=Cyc_strptrcmp;_T30=Cyc_Hashtable_hash_stringptr;{void**val=_T2A(_T2C,_T2E,_T2F,_T30);_T31=val;_T32=(unsigned long)_T31;
...
# 531
int findex=0;
_TLDA: _T52=af;_T53=(unsigned long)_T52;if(_T53)goto _TLD8;else{goto _TLD9;}
...
_TLE5: _T89=fs;_T8A=(unsigned long)_T89;if(_T8A)goto _TLE3;else{goto _TLE4;}
...
_TLE9: _T92=ft;_T93=(unsigned long)_T92;if(_T93)goto _TLE7;else{goto _TLE8;}
...
int findex=0;_T127=ad;_T128=_T127->impl;_T129=(unsigned long)_T128;
if(!_T129)goto _TL100;_T12A=ad;_T12B=_T12A->impl;{
struct Cyc_List_List*fs=_T12B->fields;_TL105: _T12C=fs;_T12D=(unsigned long)_T12C;if(_T12D)goto _TL103;else{goto _TL104;}
...
# 596
struct _fat_ptr adn=Cyc_Absynpp_fullqvar2string(n);
int findex=0;_T153=ts;_T154=(unsigned long)_T153;
if(!_T154)goto _TL108;{
int ix=0;_TL10D: _T155=ts;_T156=(unsigned long)_T155;if(_T156)goto _TL10B;else{goto _TL10C;}
...
struct Cyc_List_List*args=_T18A->args;_TL113: _T18B=args;_T18C=(unsigned long)_T18B;if(_T18C)goto _TL111;else{goto _TL112;}
...
# 619
struct _fat_ptr tn=Cyc_Absynpp_fullqvar2string(tdn);_T1AD=tdef;_T1AE=(unsigned long)_T1AD;
if(!_T1AE)goto _TL116;_T1AF=tdef;_T1B0=_T1AF->defn;_T1B1=(unsigned long)_T1B0;if(!_T1B1)goto _TL116;_T1B2=Cyc_Interproc__prefix;_T1B3=
...
# 626
int ix=0;_TL11D: _T1CD=ts;_T1CE=(unsigned long)_T1CD;if(_T1CE)goto _TL11B;else{goto _TL11C;}
...
return 1;}}
# 709
static void Cyc_Interproc_remove_local_constraints(struct Cyc_List_List*cvars,int ignore){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_List_List*_T4;
_TL12B: _T0=cvars;_T1=(unsigned long)_T0;if(_T1)goto _TL129;else{goto _TL12A;}
...
# 721
static struct Cyc_List_List*Cyc_Interproc_assign_cvar_names(struct Cyc_List_List*ds){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_Absyn_Decl*_T4;int*_T5;unsigned _T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;struct Cyc_Absyn_Vardecl*_T9;struct _tuple0*_TA;char*_TB;unsigned long _TC;struct _fat_ptr _TD;struct _fat_ptr _TE;struct _fat_ptr _TF;struct Cyc_Int_pa_PrintArg_struct _T10;struct Cyc_String_pa_PrintArg_struct _T11;struct _fat_ptr _T12;struct Cyc_Absyn_Vardecl*_T13;void*_T14;char*_T15;struct _fat_ptr _T16;unsigned long _T17;int _T18;struct Cyc_List_List*_T19;struct Cyc_List_List*_T1A;struct Cyc_Absyn_Fndecl*_T1B;struct _tuple0*_T1C;char*_T1D;unsigned long _T1E;struct _fat_ptr _T1F;struct _fat_ptr _T20;struct _fat_ptr _T21;struct Cyc_Int_pa_PrintArg_struct _T22;struct Cyc_String_pa_PrintArg_struct _T23;struct _fat_ptr _T24;struct Cyc_Absyn_Fndecl*_T25;struct _tuple0*_T26;int _T27;struct Cyc_Absyn_Fndecl*_T28;struct Cyc_Absyn_FnInfo _T29;struct Cyc_List_List*_T2A;unsigned long _T2B;struct Cyc_List_List*_T2C;struct Cyc_List_List*_T2D;unsigned long _T2E;struct Cyc_List_List*_T2F;struct Cyc_List_List*_T30;void*_T31;struct _tuple8*_T32;void*_T33;void*_T34;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T35;struct Cyc_Absyn_Fndecl*_T36;void*_T37;char*_T38;struct _fat_ptr _T39;unsigned long _T3A;int _T3B;struct Cyc_List_List*_T3C;struct Cyc_List_List*_T3D;struct _tuple18*_T3E;struct _tuple18*_T3F;struct _tuple18*_T40;struct _tuple18*_T41;void(*_T42)(int(*)(struct _tuple18*,struct Cyc_Absyn_Exp*),int(*)(struct _tuple18*,struct Cyc_Absyn_Stmt*),struct _tuple18*,struct Cyc_Absyn_Stmt*);void(*_T43)(int(*)(void*,struct Cyc_Absyn_Exp*),int(*)(void*,struct Cyc_Absyn_Stmt*),void*,struct Cyc_Absyn_Stmt*);int(*_T44)(struct _tuple18*,struct Cyc_Absyn_Exp*);int(*_T45)(struct _tuple18*,struct Cyc_Absyn_Stmt*);struct _tuple18*_T46;struct Cyc_Absyn_Fndecl*_T47;struct Cyc_Absyn_Stmt*_T48;struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_T49;struct Cyc_Absyn_Aggrdecl**_T4A;void*_T4B;struct _fat_ptr _T4C;void*_T4D;struct Cyc_List_List*_T4E;struct Cyc_List_List*_T4F;struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*_T50;struct Cyc_Absyn_Datatypedecl**_T51;void*_T52;struct _fat_ptr _T53;void*_T54;struct Cyc_List_List*_T55;struct Cyc_List_List*_T56;struct Cyc_Absyn_Typedefdecl*_T57;struct _tuple0*_T58;struct Cyc_Absyn_Typedefdecl*_T59;void*_T5A;struct Cyc_List_List*_T5B;struct Cyc_List_List*_T5C;struct Cyc_List_List*_T5D;struct Cyc_List_List*_T5E;
struct Cyc_List_List*ret=0;
_TL12F: _T0=ds;_T1=(unsigned long)_T0;if(_T1)goto _TL12D;else{goto _TL12E;}
...
struct Cyc_List_List*args=_T29.args;_T2A=args;_T2B=(unsigned long)_T2A;
if(!_T2B)goto _TL133;_T2C=args;_T2D=_T2C->tl;_T2E=(unsigned long)_T2D;if(!_T2E)goto _TL133;_T2F=args;_T30=_T2F->tl;_T31=_T30->hd;_T32=(struct _tuple8*)_T31;_T33=_T32->f2;_T34=Cyc_Absyn_fat_bound_type;
...
return _T5E;}
# 769
static struct Cyc_List_List*Cyc_Interproc_parse_constraint_graph (void){struct _fat_ptr _T0;struct Cyc_String_pa_PrintArg_struct _T1;struct _fat_ptr _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct _fat_ptr _T5;struct _fat_ptr _T6;struct Cyc___cycFILE*_T7;unsigned long _T8;struct _fat_ptr _T9;struct _fat_ptr _TA;struct Cyc_List_List*_TB;{struct Cyc_String_pa_PrintArg_struct _TC;_TC.tag=0;
...
_tag_fat("r",sizeof(char),2U);_T6=_tag_fat("constraint file",sizeof(char),16U);{struct Cyc___cycFILE*file=Cyc_Interproc_try_file_open(_T4,_T5,_T6);_T7=file;_T8=(unsigned long)_T7;
...
return 0;}
# 787
static void Cyc_Interproc_print_cvarlist(struct Cyc_List_List*l){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_List_List*_T4;
_TL13B: _T0=l;_T1=(unsigned long)_T0;if(_T1)goto _TL139;else{goto _TL13A;}
_TL139: _T2=l;_T3=_T2->hd;Cyc_Tcutil_deconstruct_type(_T3);_T4=l;
# 788
l=_T4->tl;goto _TL13B;_TL13A:;}
# 795
static void Cyc_Interproc_bind_cvars(struct Cyc_List_List*ds){int _T0;int _T1;struct Cyc_List_List*_T2;unsigned long _T3;struct Cyc_List_List*_T4;int*_T5;int _T6;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T7;void**_T8;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T9;void**_TA;void**_TB;void*_TC;int(*_TD)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_TE)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TF;struct _fat_ptr _T10;int(*_T11)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T12)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T13;struct _fat_ptr _T14;void**_T15;void*_T16;int(*_T17)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T18)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T19;struct _fat_ptr _T1A;struct Cyc_List_List*_T1B;void*_T1C;int(*_T1D)(struct _fat_ptr,struct _fat_ptr);void*(*_T1E)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T1F;struct _fat_ptr _T20;struct Cyc_List_List*_T21;_T0=Cyc_Flags_no_merge;
...
_TL143: _T2=cvars;_T3=(unsigned long)_T2;if(_T3)goto _TL141;else{goto _TL142;}
...
# 820
void Cyc_Interproc_emit_decls(struct _fat_ptr filename,struct Cyc_List_List*ds){struct _fat_ptr _T0;struct Cyc_String_pa_PrintArg_struct _T1;struct _fat_ptr _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct _fat_ptr _T5;struct _fat_ptr _T6;struct Cyc___cycFILE*_T7;unsigned long _T8;struct _fat_ptr _T9;struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_String_pa_PrintArg_struct _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct _fat_ptr _TE;struct _fat_ptr _TF;struct _fat_ptr _T10;struct _fat_ptr _T11;struct _fat_ptr _T12;struct Cyc___cycFILE*_T13;unsigned long _T14;struct Cyc_Absynpp_Params*_T15;struct Cyc_Absynpp_Params*_T16;{struct Cyc_String_pa_PrintArg_struct _T17;_T17.tag=0;
# 822
...
_tag_fat("w",sizeof(char),2U);_T6=_tag_fat("constraint file",sizeof(char),16U);{struct Cyc___cycFILE*file=Cyc_Interproc_try_file_open(_T4,_T5,_T6);_T7=file;_T8=(unsigned long)_T7;
...
_tag_fat("w",sizeof(char),2U);_T12=_tag_fat("output file",sizeof(char),12U);{struct Cyc___cycFILE*outfile=Cyc_Interproc_try_file_open(_T10,_T11,_T12);_T13=outfile;_T14=(unsigned long)_T13;
...
# 853
int Cyc_Interproc_cmp_stats(struct _tuple19*a,struct _tuple19*b){struct _fat_ptr _T0;struct _tuple19*_T1;void*_T2;void*_T3;unsigned long _T4;struct _fat_ptr _T5;struct _tuple19*_T6;void*_T7;void*_T8;unsigned long _T9;int _TA;_T1=a;{const char*_TB=_T1->f1;_T2=(void*)_TB;_T3=(void*)_TB;_T4=_get_zero_arr_size_char(_T3,1U);_T0=_tag_fat(_T2,sizeof(char),_T4);}_T6=b;{const char*_TB=_T6->f1;_T7=(void*)_TB;_T8=(void*)_TB;_T9=_get_zero_arr_size_char(_T8,1U);_T5=_tag_fat(_T7,sizeof(char),_T9);}_TA=
Cyc_strcmp(_T0,_T5);return _TA;}
# 858
struct Cyc_List_List*Cyc_Interproc_resolve_all(struct _fat_ptr filename,struct Cyc_List_List*tds){struct Cyc_List_List*_T0;struct _tuple11*_T1;struct Cyc_List_List*_T2;unsigned long _T3;struct Cyc_List_List*_T4;void*_T5;struct _tuple11*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;unsigned long _T9;struct _handler_cons*_TA;int _TB;int _TC;struct Cyc_List_List*_TD;unsigned long _TE;void*_TF;struct Cyc_Interproc_Unresolved_sym_exn_struct*_T10;char*_T11;char*_T12;struct Cyc_Warn_String_Warn_Warg_struct _T13;struct Cyc_Warn_Exp_Warn_Warg_struct _T14;struct Cyc_Absyn_Exp*_T15;unsigned _T16;struct _fat_ptr _T17;struct Cyc_List_List*_T18;unsigned long _T19;struct Cyc_List_List*_T1A;void*_T1B;struct _tuple11*_T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*_T1E;unsigned long _T1F;struct Cyc_List_List*_T20;struct Cyc_List_List*_T21;void*_T22;struct _tuple11*_T23;struct Cyc_List_List*_T24;struct Cyc_List_List*_T25;struct Cyc_List_List*_T26;
...
# 864
_TL157: _T2=worklist;_T3=(unsigned long)_T2;if(!_T3)goto _TL159;_T4=worklist;_T5=_T4->hd;_T6=(struct _tuple11*)_T5;
tds=_T6->f1;_T7=worklist;
worklist=_T7->tl;goto _TL15A;_TL159: _TL15A:{
# 868
struct Cyc_List_List*externs=Cyc_Binding_resolve_all_interproc(tds);_T8=externs;_T9=(unsigned long)_T8;
...
_TL164:{struct Cyc_List_List*_T2D=tds;_npop_handler(0);return _T2D;}_TL162: _TD=worklist;_TE=(unsigned long)_TD;
...
return 0;}_TL168: _T2A=_T29;{void*exn=_T2A;_rethrow(exn);};}_TL160:;}}goto _TL15C;_TL15B: _TL15C:;}_T18=worklist;_T19=(unsigned long)_T18;
# 863
...
struct Cyc_List_List*it=_T1D->tl;_TL16D: _T1E=it;_T1F=(unsigned long)_T1E;if(_T1F)goto _TL16B;else{goto _TL16C;}
...
# 897
void Cyc_Interproc_inference_statistics (void){struct Cyc___cycFILE*_T0;struct _fat_ptr _T1;struct _fat_ptr _T2;int _T3;struct Cyc___cycFILE*_T4;struct _fat_ptr _T5;struct _fat_ptr _T6;struct Cyc_List_List*_T7;unsigned long _T8;struct Cyc_List_List*_T9;void*_TA;void*_TB;int*_TC;int _TD;void*_TE;int*_TF;unsigned _T10;struct Cyc_Absyn_AppType_Absyn_Type_struct*_T11;void*_T12;int*_T13;unsigned _T14;struct Cyc_List_List*_T15;struct _tuple21*_T16;struct Cyc_List_List*_T17;struct _tuple21*_T18;struct Cyc_List_List*_T19;struct Cyc_Int_pa_PrintArg_struct _T1A;int _T1B;struct Cyc___cycFILE*_T1C;struct _fat_ptr _T1D;struct _fat_ptr _T1E;struct Cyc_List_List*(*_T1F)(int(*)(struct _tuple21*,struct _tuple21*),struct Cyc_List_List*);struct Cyc_List_List*(*_T20)(int(*)(void*,void*),struct Cyc_List_List*);int(*_T21)(struct _tuple21*,struct _tuple21*);struct Cyc_List_List*_T22;struct Cyc_String_pa_PrintArg_struct _T23;struct Cyc_String_pa_PrintArg_struct _T24;struct Cyc_String_pa_PrintArg_struct _T25;struct Cyc_String_pa_PrintArg_struct _T26;struct Cyc___cycFILE*_T27;struct _fat_ptr _T28;struct _fat_ptr _T29;struct Cyc___cycFILE*_T2A;struct _fat_ptr _T2B;struct _fat_ptr _T2C;struct Cyc_List_List*_T2D;unsigned long _T2E;const char*_T2F;struct Cyc_List_List*_T30;void*_T31;struct _tuple21*_T32;int _T33;const char*_T34;struct Cyc_List_List*_T35;void*_T36;struct _tuple21*_T37;int _T38;struct Cyc_String_pa_PrintArg_struct _T39;struct _fat_ptr _T3A;struct Cyc_List_List*_T3B;void*_T3C;struct _tuple21*_T3D;void*_T3E;void*_T3F;unsigned long _T40;struct Cyc_String_pa_PrintArg_struct _T41;struct _fat_ptr _T42;struct Cyc_List_List*_T43;void*_T44;struct _tuple21*_T45;void*_T46;void*_T47;unsigned long _T48;struct Cyc_String_pa_PrintArg_struct _T49;struct _fat_ptr _T4A;void*_T4B;void*_T4C;unsigned long _T4D;struct Cyc_String_pa_PrintArg_struct _T4E;struct _fat_ptr _T4F;void*_T50;void*_T51;unsigned long _T52;struct Cyc___cycFILE*_T53;struct _fat_ptr _T54;struct _fat_ptr _T55;struct Cyc_List_List*_T56;struct Cyc___cycFILE*_T57;struct _fat_ptr _T58;struct _fat_ptr _T59;struct Cyc___cycFILE*_T5A;struct _fat_ptr _T5B;struct _fat_ptr _T5C;_T0=Cyc_stderr;_T1=
...
int nips=0;
_TL173: _T7=graph;_T8=(unsigned long)_T7;if(_T8)goto _TL171;else{goto _TL172;}
...
_TL17B: _T2D=ips;_T2E=(unsigned long)_T2D;if(_T2E)goto _TL179;else{goto _TL17A;}
