...
# 112
void Cyc_Graph_print(struct Cyc___cycFILE*f,struct Cyc_Dict_Dict g,void(*nodeprint)(struct Cyc___cycFILE*,void*)){struct Cyc___cycFILE*_T0;struct _fat_ptr _T1;struct _fat_ptr _T2;struct Cyc_List_List*_T3;unsigned long _T4;struct Cyc_List_List*_T5;void*_T6;void*_T7;struct Cyc_List_List*_T8;unsigned long _T9;struct Cyc_List_List*_TA;unsigned long _TB;struct Cyc___cycFILE*_TC;struct _fat_ptr _TD;struct _fat_ptr _TE;struct Cyc___cycFILE*_TF;struct Cyc_List_List*_T10;void*_T11;struct Cyc___cycFILE*_T12;struct _fat_ptr _T13;struct _fat_ptr _T14;struct Cyc_List_List*_T15;struct Cyc___cycFILE*_T16;struct _fat_ptr _T17;struct _fat_ptr _T18;struct Cyc_List_List*_T19;struct Cyc___cycFILE*_T1A;struct _fat_ptr _T1B;struct _fat_ptr _T1C;_T0=f;_T1=
_tag_fat("digraph {\n",sizeof(char),11U);_T2=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T0,_T1,_T2);{
struct Cyc_List_List*edges=Cyc_Dict_to_list(g);
_TLC: _T3=edges;_T4=(unsigned long)_T3;if(_T4)goto _TLA;else{goto _TLB;}
...
struct Cyc_List_List*tslist=Cyc_Graph_to_list(ts);_T8=tslist;_T9=(unsigned long)_T8;
if(!_T9)goto _TLD;
_TL12: _TA=tslist;_TB=(unsigned long)_TA;if(_TB)goto _TL10;else{goto _TL11;}
...
# 140 "graph.cyc"
static struct Cyc_List_List*Cyc_Graph_sourcesOf(struct Cyc_Dict_Dict g,void*node){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;void*_T4;int _T5;struct Cyc_List_List*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;
struct Cyc_List_List*result=0;{
# 143
struct Cyc_List_List*edges=Cyc_Dict_to_list(g);_TL16: _T0=edges;_T1=(unsigned long)_T0;if(_T1)goto _TL14;else{goto _TL15;}
...
struct Cyc_List_List*s=sourceSources;_TL1E: _T4=s;_T5=(unsigned long)_T4;if(_T5)goto _TL1C;else{goto _TL1D;}
...
return _TB;}}}}
# 179
struct Cyc_Dict_Dict Cyc_Graph_tc_slow(struct Cyc_Dict_Dict g){struct Cyc_Dict_Dict _T0;int(*_T1)(void*,void*);struct Cyc_List_List*_T2;unsigned long _T3;struct Cyc_List_List*_T4;void*_T5;void*_T6;struct Cyc_List_List*_T7;unsigned long _T8;struct Cyc_List_List*_T9;unsigned long _TA;struct Cyc_Dict_Dict _TB;void*_TC;struct Cyc_List_List*_TD;void*_TE;struct Cyc_List_List*_TF;struct Cyc_List_List*_T10;struct Cyc_Dict_Dict _T11;_T0=g;_T1=_T0.rel;{
struct Cyc_Dict_Dict result=Cyc_Graph_empty(_T1);
struct Cyc_List_List*edges=Cyc_Dict_to_list(g);
_TL22: _T2=edges;_T3=(unsigned long)_T2;if(_T3)goto _TL20;else{goto _TL21;}
...
struct Cyc_List_List*tslist=Cyc_Graph_to_list(targets);_T7=tslist;_T8=(unsigned long)_T7;
if(!_T8)goto _TL23;{
struct Cyc_List_List*t=tslist;_TL28: _T9=t;_TA=(unsigned long)_T9;if(_TA)goto _TL26;else{goto _TL27;}
...
return _T11;}}
# 197
struct Cyc_Dict_Dict Cyc_Graph_tkernel(struct Cyc_Dict_Dict g){struct Cyc_Dict_Dict _T0;int(*_T1)(void*,void*);int(*_T2)(void*,void*);struct Cyc_List_List*_T3;unsigned long _T4;struct Cyc_List_List*_T5;void*_T6;void*_T7;int _T8;int _T9;struct Cyc_List_List*_TA;struct Cyc_Dict_Dict _TB;_T0=g;{
...
struct Cyc_List_List*edges=Cyc_Dict_to_list(g);_TL2C: _T3=edges;_T4=(unsigned long)_T3;if(_T4)goto _TL2A;else{goto _TL2B;}
...
# 298
_TL51: _T7D=ts;_T7E=_T7D->nstack;_T7F=(unsigned long)_T7E;if(_T7F)goto _TL52;else{goto _TL53;}
...
_TC->cstack=0;{
# 319
struct Cyc_List_List*edges=Cyc_Dict_to_list(g);_TL59: _TD=edges;_TE=(unsigned long)_TD;if(_TE)goto _TL57;else{goto _TL58;}
...
struct Cyc_List_List*s=*_T34;_TL74: _T35=s;_T36=(unsigned long)_T35;if(_T36)goto _TL72;else{goto _TL73;}
...
# 378
_TL7A: _T3A=S;_T3B=*_T3A;_T3C=(unsigned long)_T3B;if(_T3C)goto _TL78;else{goto _TL79;}
...
# 390
struct Cyc_Dict_Dict Cyc_Graph_scc(struct Cyc_Dict_Dict input){struct Cyc_Dict_Dict _T0;int(*_T1)(void*,void*);int(*_T2)(void*,void*);struct Cyc_List_List*_T3;unsigned long _T4;struct Cyc_List_List*_T5;void*_T6;void*_T7;struct Cyc_Dict_Dict(*_T8)(struct Cyc_Dict_Dict,void*,unsigned);struct Cyc_Dict_Dict(*_T9)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_List_List*_TA;struct Cyc_List_List*_TB;unsigned long _TC;struct Cyc_List_List*_TD;void*_TE;void*_TF;unsigned(*_T10)(struct Cyc_Dict_Dict,void*);void*(*_T11)(struct Cyc_Dict_Dict,void*);unsigned _T12;struct Cyc_Dict_Dict _T13;struct Cyc_Dict_Dict*_T14;struct Cyc_Dict_Dict*_T15;struct Cyc_Dict_Dict*_T16;struct Cyc_Dict_Dict*_T17;struct Cyc_List_List**_T18;void*_T19;struct Cyc_List_List*_T1A;struct Cyc_Dict_Dict _T1B;_T0=input;{
int(*cmp)(void*,void*)=_T0.rel;
...
struct Cyc_List_List*e=edges;_TL80: _T3=e;_T4=(unsigned long)_T3;if(_T4)goto _TL7E;else{goto _TL7F;}
...
# 400
struct Cyc_List_List*e=edges;_TL84: _TB=e;_TC=(unsigned long)_TB;if(_TC)goto _TL82;else{goto _TL83;}
...
struct Cyc_List_List*s=*_T33;_TL94: _T34=s;_T35=(unsigned long)_T34;if(_T35)goto _TL92;else{goto _TL93;}
...
# 432
_TL9A: _T39=S;_T3A=*_T39;_T3B=(unsigned long)_T3A;if(_T3B)goto _TL98;else{goto _TL99;}
...
# 443
struct Cyc_List_List*Cyc_Graph_tsort(struct Cyc_Dict_Dict input){struct Cyc_Dict_Dict _T0;int(*_T1)(void*,void*);struct Cyc_List_List*_T2;unsigned long _T3;struct Cyc_List_List*_T4;void*_T5;void*_T6;struct Cyc_Dict_Dict(*_T7)(struct Cyc_Dict_Dict,void*,unsigned);struct Cyc_Dict_Dict(*_T8)(struct Cyc_Dict_Dict,void*,void*);struct Cyc_List_List*_T9;struct Cyc_List_List*_TA;unsigned long _TB;struct Cyc_List_List*_TC;void*_TD;void*_TE;unsigned(*_TF)(struct Cyc_Dict_Dict,void*);void*(*_T10)(struct Cyc_Dict_Dict,void*);unsigned _T11;struct Cyc_Dict_Dict _T12;struct Cyc_List_List**_T13;struct Cyc_Dict_Dict*_T14;struct Cyc_Dict_Dict*_T15;struct Cyc_List_List**_T16;void*_T17;struct Cyc_List_List*_T18;struct Cyc_List_List*_T19;_T0=input;{
int(*cmp)(void*,void*)=_T0.rel;
...
struct Cyc_List_List*e=edges;_TLA0: _T2=e;_T3=(unsigned long)_T2;if(_T3)goto _TL9E;else{goto _TL9F;}
...
# 453
struct Cyc_List_List*e=edges;_TLA4: _TA=e;_TB=(unsigned long)_TA;if(_TB)goto _TLA2;else{goto _TLA3;}
