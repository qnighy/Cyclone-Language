...
# 48 "buffer.cyc"
struct Cyc_Buffer_t*Cyc_Buffer_create(unsigned n){struct _fat_ptr _T0;struct _RegionHandle*_T1;unsigned long _T2;void*_T3;struct Cyc_Buffer_t*_T4;struct Cyc_Buffer_t*_T5;
if(n <= 0U)goto _TL0;{unsigned long _T6=n + 1U;_T1=Cyc_Core_heap_region;_T2=Cyc_Core_unique_qual;_T3=_region_calloc(_T1,_T2,sizeof(char),_T6);_T0=_tag_fat(_T3,sizeof(char),_T6);}{
...
return _TB;}}
# 67
struct _fat_ptr Cyc_Buffer_extract(struct Cyc_Buffer_t*b){struct Cyc_Buffer_t*_T0;struct Cyc_Buffer_t*_T1;struct _fat_ptr _T2;struct Cyc_Buffer_t*_T3;unsigned _T4;int _T5;unsigned char*_T6;char*_T7;unsigned long _T8;unsigned char*_T9;char*_TA;struct Cyc_Buffer_t*_TB;struct Cyc_Buffer_t*_TC;struct _fat_ptr _TD;
struct _fat_ptr buf=_tag_fat(0,0,0);{
...
return _TD;}
# 76
int Cyc_Buffer_restore(struct Cyc_Buffer_t*b,struct _fat_ptr buf){unsigned long _T0;struct Cyc_Buffer_t*_T1;struct Cyc_Buffer_t*_T2;struct _fat_ptr _T3;unsigned char*_T4;char*_T5;struct Cyc_Buffer_t*_T6;struct Cyc_Buffer_t*_T7;void(*_T8)(char*);void(*_T9)(void*);struct _fat_ptr _TA;unsigned long _TB;unsigned char*_TC;char*_TD;struct Cyc_Buffer_t*_TE;struct Cyc_Buffer_t*_TF;int _T10;_T0=
...
_T0->position=0U;}
# 97
void Cyc_Buffer_reset(struct Cyc_Buffer_t*b){struct Cyc_Buffer_t*_T0;struct Cyc_Buffer_t*_T1;struct _fat_ptr _T2;unsigned char*_T3;char*_T4;struct Cyc_Buffer_t*_T5;struct Cyc_Buffer_t*_T6;struct Cyc_Buffer_t*_T7;struct _fat_ptr _T8;unsigned long _T9;struct Cyc_Buffer_t*_TA;struct Cyc_Buffer_t*_TB;void(*_TC)(char*);void(*_TD)(void*);struct _fat_ptr _TE;unsigned long _TF;unsigned char*_T10;char*_T11;_T0=b;
...
# 106
 return;}
# 109
static void Cyc_Buffer_resize(struct Cyc_Buffer_t*b,unsigned more){struct Cyc_Buffer_t*_T0;unsigned _T1;struct Cyc_Buffer_t*_T2;unsigned _T3;unsigned _T4;unsigned _T5;unsigned long _T6;struct _fat_ptr _T7;struct _RegionHandle*_T8;unsigned long _T9;void*_TA;struct Cyc_Buffer_t*_TB;unsigned _TC;struct _fat_ptr _TD;struct _fat_ptr _TE;struct Cyc_Buffer_t*_TF;struct _fat_ptr _T10;struct Cyc_Buffer_t*_T11;unsigned _T12;struct Cyc_Buffer_t*_T13;struct _fat_ptr _T14;unsigned char*_T15;char*_T16;struct Cyc_Buffer_t*_T17;struct Cyc_Buffer_t*_T18;struct Cyc_Buffer_t*_T19;struct Cyc_Buffer_t*_T1A;struct Cyc_Buffer_t*_T1B;struct Cyc_Buffer_t*_T1C;void(*_T1D)(char*);void(*_T1E)(void*);struct _fat_ptr _T1F;unsigned long _T20;unsigned char*_T21;char*_T22;struct Cyc_Buffer_t*_T23;_T0=b;{
...
_TLD: new_len=2U * new_len;goto _TLC;_TLE:{unsigned long _T24=new_len + 1U;_T8=Cyc_Core_heap_region;_T9=Cyc_Core_unique_qual;_TA=_region_calloc(_T8,_T9,sizeof(char),_T24);_T7=_tag_fat(_TA,sizeof(char),_T24);}
# 116
...
return;}}}
# 129
void Cyc_Buffer_add_char(struct Cyc_Buffer_t*b,char c){struct Cyc_Buffer_t*_T0;unsigned _T1;int _T2;unsigned _T3;struct Cyc_Buffer_t*_T4;unsigned _T5;struct Cyc_Buffer_t*_T6;struct _fat_ptr _T7;int _T8;unsigned char*_T9;char*_TA;unsigned long _TB;unsigned char*_TC;char*_TD;struct Cyc_Buffer_t*_TE;int _TF;_T0=b;_T1=_T0->position;{
...
return;}}
# 140
void Cyc_Buffer_add_substring(struct Cyc_Buffer_t*b,struct _fat_ptr s,int offset,int len){int _T0;unsigned long _T1;struct _fat_ptr _T2;unsigned long _T3;struct Cyc_Core_Invalid_argument_exn_struct*_T4;void*_T5;struct Cyc_Buffer_t*_T6;unsigned _T7;int _T8;unsigned _T9;unsigned _TA;int _TB;unsigned _TC;struct Cyc_Buffer_t*_TD;unsigned _TE;struct Cyc_Buffer_t*_TF;int _T10;unsigned _T11;struct Cyc_Buffer_t*_T12;struct Cyc_Buffer_t*_T13;struct _fat_ptr _T14;struct Cyc_Buffer_t*_T15;unsigned _T16;int _T17;struct _fat_ptr _T18;struct _fat_ptr _T19;struct _fat_ptr _T1A;int _T1B;struct _fat_ptr _T1C;int _T1D;unsigned long _T1E;struct Cyc_Buffer_t*_T1F;struct Cyc_Buffer_t*_T20;struct Cyc_Buffer_t*_T21;int _T22;
if(offset < 0)goto _TL19;else{goto _TL1B;}_TL1B: if(len < 0)goto _TL19;else{goto _TL1A;}_TL1A: _T0=offset + len;_T1=(unsigned long)_T0;_T2=s;_T3=_get_fat_size(_T2,sizeof(char));if(_T1 > _T3)goto _TL19;else{goto _TL17;}
