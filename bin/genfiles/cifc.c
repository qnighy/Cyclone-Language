...
return _T8;}default:
 return 0;};}}
# 74
static struct Cyc_Absyn_Decl*Cyc_Cifc_lookup_concrete_decl(struct Cyc_List_List*decls,struct _fat_ptr*name){struct Cyc_List_List*_T0;void*_T1;struct Cyc_Absyn_Decl*_T2;struct _fat_ptr*_T3;unsigned long _T4;int _T5;struct Cyc_List_List*_T6;void*_T7;struct Cyc_Absyn_Decl*_T8;int _T9;struct Cyc_List_List*_TA;void*_TB;struct Cyc_Absyn_Decl*_TC;struct Cyc_List_List*_TD;struct Cyc_Absyn_Decl*_TE;
# 76
struct Cyc_List_List*indecls=decls;
_TL5: if(decls!=0)goto _TL3;else{goto _TL4;}
_TL3: _T0=decls;_T1=_T0->hd;_T2=(struct Cyc_Absyn_Decl*)_T1;{struct _fat_ptr*dname=Cyc_Absyn_decl_name(_T2);_T3=dname;_T4=(unsigned long)_T3;
...
# 90
struct _fat_ptr Cyc_Cifc_list2string(struct Cyc_List_List*l,struct _fat_ptr(*tostr)(void*)){struct _fat_ptr _T0;struct _fat_ptr _T1;struct Cyc_List_List*_T2;unsigned long _T3;struct _fat_ptr _T4;struct Cyc_String_pa_PrintArg_struct _T5;struct Cyc_String_pa_PrintArg_struct _T6;struct _fat_ptr(*_T7)(void*);struct _fat_ptr(*_T8)(void*);struct Cyc_List_List*_T9;void*_TA;struct _fat_ptr _TB;struct _fat_ptr _TC;struct Cyc_List_List*_TD;struct _fat_ptr _TE;struct Cyc_String_pa_PrintArg_struct _TF;struct _fat_ptr _T10;struct _fat_ptr _T11;_T0=
_tag_fat("(",sizeof(char),2U);_T1=_tag_fat(0U,sizeof(void*),0);{struct _fat_ptr ret=Cyc_aprintf(_T0,_T1);
_TLC: _T2=l;_T3=(unsigned long)_T2;if(_T3)goto _TLA;else{goto _TLB;}
...
_TL16: _T18=args;_T19=(unsigned long)_T18;if(_T19)goto _TL17;else{goto _TL18;}
...
# 268 "cifc.cyc"
static int Cyc_Cifc_check_fntype_kinds(unsigned loc,struct Cyc_Tcenv_Tenv*te,void*c_typ,void*u_typ){struct _tuple11 _T0;void*_T1;int*_T2;int _T3;void*_T4;int*_T5;int _T6;void*_T7;void*_T8;unsigned _T9;struct Cyc_Tcenv_Tenv*_TA;struct Cyc_Absyn_FnInfo _TB;void*_TC;struct Cyc_Absyn_FnInfo _TD;void*_TE;int _TF;struct Cyc_Absyn_FnInfo _T10;struct Cyc_Absyn_FnInfo _T11;struct Cyc_List_List*_T12;unsigned long _T13;int _T14;struct Cyc_List_List*_T15;unsigned long _T16;unsigned _T17;struct Cyc_Tcenv_Tenv*_T18;struct Cyc_List_List*_T19;void*_T1A;struct _tuple8*_T1B;struct _tuple8 _T1C;void*_T1D;struct Cyc_List_List*_T1E;void*_T1F;struct _tuple8*_T20;struct _tuple8 _T21;void*_T22;struct Cyc_List_List*_T23;struct Cyc_List_List*_T24;int _T25;{struct _tuple11 _T26;
...
_TL37: _T12=ca;_T13=(unsigned long)_T12;if(_T13)goto _TL3A;else{goto _TL39;}_TL3A: _T14=typesOk;if(_T14)goto _TL38;else{goto _TL39;}
_TL38: _T15=ua;_T16=(unsigned long)_T15;if(_T16)goto _TL3B;else{goto _TL3D;}
...
# 401
if(_TCA==0)goto _TL89;_TCB=cd;_TCC=ud;_TCB->tvs=_TCC->tvs;goto _TL8A;_TL89: _TL8A: _TCD=tvars;_TCE=(unsigned long)_TCD;
if(!_TCE)goto _TL8B;_TCF=tvarsC;*_TCF=tvars;goto _TL8C;_TL8B: _TL8C: _TD0=effc;_TD1=(unsigned long)_TD0;
if(!_TD1)goto _TL8D;_TD2=effcC;*_TD2=effc;goto _TL8E;_TL8D: _TL8E: _TD3=qb;_TD4=(unsigned long)_TD3;
...
# 517
 return 0;;}_TLC2:;};}
# 522
static int Cyc_Cifc_find_and_remove(struct Cyc_List_List**lst,void*kind){struct Cyc_List_List**_T0;struct Cyc_List_List*_T1;unsigned long _T2;struct Cyc_List_List*_T3;void*_T4;int*_T5;int _T6;void*_T7;struct Cyc_Absyn_Tvar*_T8;void*_T9;void*_TA;int _TB;struct Cyc_List_List*_TC;unsigned long _TD;struct Cyc_List_List*_TE;struct Cyc_List_List*_TF;struct Cyc_List_List**_T10;struct Cyc_List_List*_T11;struct Cyc_List_List*_T12;struct Cyc_String_pa_PrintArg_struct _T13;struct Cyc_String_pa_PrintArg_struct _T14;int(*_T15)(struct _fat_ptr,struct _fat_ptr);void*(*_T16)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T17;struct _fat_ptr _T18;struct Cyc_List_List*_T19;_T0=lst;{
struct Cyc_List_List*cur=*_T0;
struct Cyc_List_List*prev=0;
_TLCD: _T1=cur;_T2=(unsigned long)_T1;if(_T2)goto _TLCE;else{goto _TLCF;}
...
# 529
Cyc_Cifc_kindbound_subsumed(_T9,_TA);if(!_TB)goto _TLD2;_TC=prev;_TD=(unsigned long)_TC;
...
# 610
struct Cyc_Absyn_Decl*ovd=Cyc_Absyn_lookup_decl(tv_ovrs,name);_T13=ovd;_T14=(unsigned long)_T13;
...
_TLF8: _T22=tvs;_T23=(unsigned long)_T22;if(_T23)goto _TLF9;else{goto _TLFA;}
...
_TL108: _T62=argit;_T63=(unsigned long)_T62;if(_T63)goto _TL109;else{goto _TL10A;}
...
struct _tuple13*ar_tup=Cyc_Cifc_update_tvars(te,tv_ovrs,at,enclosing_decl,instantiate);_T66=ar_tup;_T67=(unsigned long)_T66;
if(!_T67)goto _TL10B;_T68=ar_tup;_T69=*_T68;_T6A=_T69.f0;_T6B=(unsigned long)_T6A;
if(!_T6B)goto _TL10D;_T6C=ar_tup;_T6D=*_T6C;_T6E=_T6D.f0;_T6F=added_tvars;
added_tvars=Cyc_List_append(_T6E,_T6F);goto _TL10E;_TL10D: _TL10E: _T70=ar_tup;_T71=*_T70;_T72=_T71.f1;_T73=(unsigned long)_T72;
...
# 681
argit=_T78->tl;}}goto _TL108;_TL10A: _T79=added_tvars;_T7A=(unsigned long)_T79;
# 683
if(_T7A)goto _TL113;else{goto _TL114;}_TL114: _T7B=removed_tvars;_T7C=(unsigned long)_T7B;if(_T7C)goto _TL113;else{goto _TL111;}
...
return 0;}
# 694
static int Cyc_Cifc_update_fninfo_usage(unsigned loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*tv_ovrs,struct Cyc_Absyn_FnInfo*fi,struct Cyc_Absyn_Decl*enclosing_decl){struct Cyc_Tcenv_Tenv*_T0;struct Cyc_List_List*_T1;struct Cyc_Absyn_FnInfo*_T2;void*_T3;struct Cyc_Absyn_Decl*_T4;struct Cyc_Absyn_FnInfo*_T5;struct Cyc_List_List*_T6;struct _tuple13*_T7;unsigned long _T8;struct _tuple13*_T9;struct _tuple13 _TA;struct Cyc_List_List*_TB;struct _tuple13*_TC;unsigned long _TD;struct _tuple13*_TE;struct _tuple13 _TF;struct Cyc_List_List*_T10;unsigned long _T11;struct Cyc_List_List*_T12;void*_T13;void**_T14;struct Cyc_Tcenv_Tenv*_T15;struct Cyc_List_List*_T16;void**_T17;void*_T18;struct Cyc_Absyn_Decl*_T19;struct _tuple13*_T1A;unsigned long _T1B;struct _tuple13*_T1C;struct _tuple13 _T1D;struct Cyc_List_List*_T1E;struct Cyc_List_List*_T1F;struct _tuple13*_T20;struct _tuple13 _T21;struct Cyc_List_List*_T22;struct Cyc_List_List*_T23;struct Cyc_List_List*_T24;struct Cyc_List_List*_T25;unsigned long _T26;struct Cyc_List_List*_T27;void*_T28;struct _handler_cons*_T29;int _T2A;struct Cyc_Absyn_FnInfo*_T2B;struct Cyc_List_List*(*_T2C)(struct Cyc_List_List*,struct Cyc_Absyn_Tvar*);struct Cyc_List_List*(*_T2D)(struct Cyc_List_List*,void*);struct Cyc_Absyn_FnInfo*_T2E;struct Cyc_List_List*_T2F;struct Cyc_Absyn_Tvar*_T30;void*_T31;struct Cyc_Core_Not_found_exn_struct*_T32;char*_T33;char*_T34;struct Cyc_String_pa_PrintArg_struct _T35;unsigned _T36;struct _fat_ptr _T37;struct _fat_ptr _T38;struct Cyc_List_List*_T39;struct Cyc_List_List*_T3A;unsigned long _T3B;struct Cyc_Absyn_FnInfo*_T3C;struct Cyc_List_List*_T3D;struct Cyc_Absyn_FnInfo*_T3E;struct Cyc_List_List*_T3F;struct Cyc_Absyn_FnInfo*_T40;int _T41;_T0=te;_T1=tv_ovrs;_T2=
_check_null(fi);_T3=_T2->ret_type;_T4=enclosing_decl;{struct _tuple13*ad=Cyc_Cifc_update_tvars(_T0,_T1,_T3,_T4,0);_T5=fi;{
# 697
struct Cyc_List_List*argit=_T5->args;_T7=ad;_T8=(unsigned long)_T7;
if(!_T8)goto _TL115;_T9=ad;_TA=*_T9;_T6=_TA.f0;goto _TL116;_TL115: _T6=0;_TL116: {struct Cyc_List_List*added_tvars=_T6;_TC=ad;_TD=(unsigned long)_TC;
if(!_TD)goto _TL117;_TE=ad;_TF=*_TE;_TB=_TF.f1;goto _TL118;_TL117: _TB=0;_TL118: {struct Cyc_List_List*removed_tvars=_TB;
int change=0;
_TL119: _T10=argit;_T11=(unsigned long)_T10;if(_T11)goto _TL11A;else{goto _TL11B;}
...
struct _tuple13*ad=Cyc_Cifc_update_tvars(_T15,_T16,_T18,_T19,0);_T1A=ad;_T1B=(unsigned long)_T1A;
...
# 710
 _TL11E: _T25=removed_tvars;_T26=(unsigned long)_T25;if(_T26)goto _TL11F;else{goto _TL120;}
...
# 721
removed_tvars=_T39->tl;}goto _TL11E;_TL120: _T3A=added_tvars;_T3B=(unsigned long)_T3A;
# 723
if(!_T3B)goto _TL128;
...
return _T41;}}}}}
# 732
static struct Cyc_List_List*Cyc_Cifc_remove_cur(struct Cyc_List_List*head,struct Cyc_List_List*cur,struct Cyc_List_List*prev){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;struct Cyc_List_List*_T3;struct Cyc_List_List*_T4;struct Cyc_List_List*_T5;_T0=prev;_T1=(unsigned long)_T0;
...
return _T5;}
# 741
static int Cyc_Cifc_decl_name_cmp(struct Cyc_Absyn_Decl*a,struct Cyc_Absyn_Decl*b){int _T0;int _T1;struct _fat_ptr*_T2;unsigned long _T3;struct _fat_ptr*_T4;struct _fat_ptr _T5;struct _fat_ptr*_T6;struct _fat_ptr _T7;int _T8;
struct _fat_ptr*na=Cyc_Absyn_decl_name(a);
struct _fat_ptr*nb=Cyc_Absyn_decl_name(b);_T0=na==0;_T1=nb==0;
if(!(_T0 ^ _T1))goto _TL12C;
return 1;_TL12C: _T2=na;_T3=(unsigned long)_T2;
if(!_T3)goto _TL12E;_T4=na;_T5=*_T4;_T6=
_check_null(nb);_T7=*_T6;_T8=Cyc_strcmp(_T5,_T7);return _T8;_TL12E:
 return 1;}
# 752
static void Cyc_Cifc_deconstruct_type(void*t){struct Cyc_String_pa_PrintArg_struct _T0;struct Cyc___cycFILE*_T1;struct _fat_ptr _T2;struct _fat_ptr _T3;void*_T4;int*_T5;unsigned _T6;void*_T7;void*_T8;struct Cyc___cycFILE*_T9;struct _fat_ptr _TA;struct _fat_ptr _TB;struct Cyc_List_List*_TC;unsigned long _TD;struct Cyc_List_List*_TE;void*_TF;struct Cyc_List_List*_T10;struct Cyc___cycFILE*_T11;struct _fat_ptr _T12;struct _fat_ptr _T13;struct Cyc___cycFILE*_T14;struct _fat_ptr _T15;struct _fat_ptr _T16;struct Cyc___cycFILE*_T17;struct _fat_ptr _T18;struct _fat_ptr _T19;void*_T1A;struct Cyc_String_pa_PrintArg_struct _T1B;struct Cyc_Absyn_Tvar*_T1C;void*_T1D;struct Cyc___cycFILE*_T1E;struct _fat_ptr _T1F;struct _fat_ptr _T20;void*_T21;void*_T22;struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T23;struct Cyc_Absyn_PtrInfo*_T24;struct Cyc___cycFILE*_T25;struct _fat_ptr _T26;struct _fat_ptr _T27;struct Cyc_Absyn_PtrInfo*_T28;void*_T29;struct Cyc___cycFILE*_T2A;struct _fat_ptr _T2B;struct _fat_ptr _T2C;void*_T2D;void*_T2E;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T2F;struct Cyc_Absyn_FnInfo*_T30;struct Cyc___cycFILE*_T31;struct _fat_ptr _T32;struct _fat_ptr _T33;struct Cyc_Absyn_FnInfo*_T34;struct Cyc_List_List*_T35;unsigned long _T36;struct Cyc_String_pa_PrintArg_struct _T37;struct Cyc_List_List*_T38;void*_T39;struct Cyc_Absyn_Tvar*_T3A;struct Cyc___cycFILE*_T3B;struct _fat_ptr _T3C;struct _fat_ptr _T3D;struct Cyc_List_List*_T3E;struct Cyc_Absyn_FnInfo*_T3F;struct Cyc_List_List*_T40;unsigned long _T41;struct Cyc_List_List*_T42;void*_T43;struct Cyc___cycFILE*_T44;struct _fat_ptr _T45;struct _fat_ptr _T46;struct Cyc_List_List*_T47;struct Cyc___cycFILE*_T48;struct _fat_ptr _T49;struct _fat_ptr _T4A;void*_T4B;void*_T4C;struct Cyc___cycFILE*_T4D;struct _fat_ptr _T4E;struct _fat_ptr _T4F;struct Cyc_List_List*_T50;unsigned long _T51;struct Cyc_String_pa_PrintArg_struct _T52;struct Cyc_List_List*_T53;void*_T54;struct Cyc___cycFILE*_T55;struct _fat_ptr _T56;struct _fat_ptr _T57;struct Cyc_List_List*_T58;void*_T59;unsigned long _T5A;struct Cyc_String_pa_PrintArg_struct _T5B;struct Cyc___cycFILE*_T5C;struct _fat_ptr _T5D;struct _fat_ptr _T5E;struct Cyc___cycFILE*_T5F;struct _fat_ptr _T60;struct _fat_ptr _T61;struct Cyc___cycFILE*_T62;struct _fat_ptr _T63;struct _fat_ptr _T64;struct Cyc___cycFILE*_T65;struct _fat_ptr _T66;struct _fat_ptr _T67;struct Cyc___cycFILE*_T68;struct _fat_ptr _T69;struct _fat_ptr _T6A;{struct Cyc_String_pa_PrintArg_struct _T6B;_T6B.tag=0;
...
# 758
_TL131: _TC=ts;_TD=(unsigned long)_TC;if(_TD)goto _TL132;else{goto _TL133;}
...
_TL134: _T35=tvit;_T36=(unsigned long)_T35;if(_T36)goto _TL135;else{goto _TL136;}
...
_TL137: _T40=argit;_T41=(unsigned long)_T40;if(_T41)goto _TL138;else{goto _TL139;}
...
_TL13A: _T50=ts;_T51=(unsigned long)_T50;if(_T51)goto _TL13B;else{goto _TL13C;}
...
ts=_T58->tl;goto _TL13A;_TL13C: _T59=topt;_T5A=(unsigned long)_T59;
# 798
...
# 858
_check_null(_T6);_T8=tv_ovrs;{struct _tuple13*new_old_tvars=Cyc_Cifc_add_tvars_to_type(_T3,_T4,_T7,_T8);_T9=new_old_tvars;_TA=(unsigned long)_T9;
...
# 861
_TL148: _TC=ot;_TD=(unsigned long)_TC;if(_TD)goto _TL149;else{goto _TL14A;}
...
return _T20;}}
# 881
static struct Cyc_List_List*Cyc_Cifc_update_usages(unsigned loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*in_tv_ovrs,struct Cyc_List_List*dsmm){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_Absyn_Decl*_T4;int*_T5;unsigned _T6;struct Cyc_Absyn_Vardecl*_T7;int*_T8;unsigned _T9;struct Cyc_Absyn_FnType_Absyn_Type_struct*_TA;struct Cyc_Absyn_FnInfo*_TB;void*_TC;struct Cyc_Tcenv_Tenv*_TD;struct Cyc_List_List*_TE;struct Cyc_Absyn_Vardecl*_TF;void*_T10;struct Cyc_Absyn_Decl*_T11;struct _tuple13*_T12;struct Cyc_Absyn_PtrInfo _T13;struct Cyc_Absyn_ArrayInfo _T14;struct _tuple13*_T15;unsigned _T16;struct Cyc_Tcenv_Tenv*_T17;struct Cyc_List_List*_T18;struct Cyc_Absyn_Fndecl*_T19;struct Cyc_Absyn_FnInfo*_T1A;struct Cyc_Absyn_FnInfo*_T1B;struct Cyc_Absyn_Decl*_T1C;struct Cyc_Absyn_Aggrdecl*_T1D;struct Cyc_Absyn_AggrdeclImpl*_T1E;unsigned long _T1F;struct Cyc_Absyn_Aggrdecl*_T20;struct Cyc_Absyn_AggrdeclImpl*_T21;struct Cyc_List_List*_T22;unsigned long _T23;struct Cyc_List_List*_T24;void*_T25;struct Cyc_Tcenv_Tenv*_T26;struct Cyc_List_List*_T27;struct Cyc_Absyn_Aggrfield*_T28;void*_T29;struct Cyc_Absyn_Decl*_T2A;struct _tuple13*_T2B;unsigned long _T2C;struct _tuple13*_T2D;struct _tuple13 _T2E;struct Cyc_List_List*_T2F;unsigned long _T30;struct _tuple13*_T31;struct _tuple13 _T32;struct Cyc_List_List*_T33;unsigned long _T34;struct Cyc_List_List*_T35;struct Cyc_List_List*_T36;unsigned long _T37;struct Cyc_List_List*_T38;void*_T39;struct _handler_cons*_T3A;int _T3B;struct Cyc_Absyn_Aggrdecl*_T3C;struct Cyc_List_List*(*_T3D)(struct Cyc_List_List*,struct Cyc_Absyn_Tvar*);struct Cyc_List_List*(*_T3E)(struct Cyc_List_List*,void*);struct Cyc_Absyn_Aggrdecl*_T3F;struct Cyc_List_List*_T40;struct Cyc_Absyn_Tvar*_T41;void*_T42;struct Cyc_Core_Not_found_exn_struct*_T43;char*_T44;char*_T45;struct Cyc_String_pa_PrintArg_struct _T46;unsigned _T47;struct _fat_ptr _T48;struct _fat_ptr _T49;struct Cyc_List_List*_T4A;struct Cyc_List_List*_T4B;unsigned long _T4C;struct Cyc_Absyn_Aggrdecl*_T4D;struct Cyc_List_List*_T4E;struct Cyc_Absyn_Aggrdecl*_T4F;struct Cyc_List_List*_T50;struct _handler_cons*_T51;int _T52;struct Cyc_List_List*(*_T53)(int(*)(struct Cyc_Absyn_Decl*,struct Cyc_Absyn_Decl*),struct Cyc_List_List*,struct Cyc_Absyn_Decl*);struct Cyc_List_List*(*_T54)(int(*)(void*,void*),struct Cyc_List_List*,void*);struct Cyc_List_List*_T55;struct Cyc_Absyn_Decl*_T56;void*_T57;struct Cyc_Core_Not_found_exn_struct*_T58;char*_T59;char*_T5A;struct Cyc_List_List*_T5B;int _T5C;struct Cyc_List_List*_T5D;struct Cyc_Absyn_Aggrdecl*_T5E;struct Cyc_Absyn_Decl*_T5F;unsigned long _T60;struct Cyc_Absyn_Decl*_T61;int*_T62;int _T63;struct Cyc_Absyn_Aggrdecl*_T64;struct Cyc_List_List*_T65;unsigned long _T66;struct Cyc_List_List*_T67;void*_T68;struct Cyc_Absyn_Tvar*_T69;struct Cyc_Absyn_Tvar*_T6A;struct _fat_ptr*_T6B;struct _fat_ptr _T6C;struct Cyc_Int_pa_PrintArg_struct _T6D;int _T6E;struct _fat_ptr _T6F;struct _fat_ptr _T70;struct Cyc_Absyn_Tvar*_T71;struct Cyc_Absyn_Aggrdecl*_T72;struct Cyc_List_List*_T73;struct Cyc_Absyn_Aggrdecl*_T74;struct Cyc_List_List*_T75;struct Cyc_Absyn_Aggrdecl*_T76;struct Cyc_Absyn_Aggrdecl*_T77;struct Cyc_List_List*_T78;int(*_T79)(struct _fat_ptr,struct _fat_ptr);void*(*_T7A)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T7B;struct _fat_ptr _T7C;struct Cyc_List_List*_T7D;int _T7E;int _T7F;unsigned _T80;struct Cyc_String_pa_PrintArg_struct _T81;struct Cyc___cycFILE*_T82;struct _fat_ptr _T83;struct _fat_ptr _T84;struct Cyc_Warn_String_Warn_Warg_struct _T85;unsigned _T86;struct _fat_ptr _T87;struct Cyc_List_List*_T88;
unsigned niter=0U;
...
struct Cyc_List_List*prev=0;
some_change=0;
_TL14D: _T0=ds;_T1=(unsigned long)_T0;if(_T1)goto _TL14E;else{goto _TL14F;}
...
# 922
changed=Cyc_Cifc_update_fninfo_usage(_T16,_T17,_T18,_T1B,_T1C);goto _LL0;}case 5:{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T8E=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T89;_T8B=_T8E->f1;}{struct Cyc_Absyn_Aggrdecl*ad=_T8B;_T1D=ad;_T1E=_T1D->impl;_T1F=(unsigned long)_T1E;
# 928
if(!_T1F)goto _TL152;_T20=ad;_T21=_T20->impl;{
struct Cyc_List_List*fit=_T21->fields;
struct Cyc_List_List*added_tvars=0;
struct Cyc_List_List*removed_tvars=0;
_TL154: _T22=fit;_T23=(unsigned long)_T22;if(_T23)goto _TL155;else{goto _TL156;}
...
struct _tuple13*tvtup=Cyc_Cifc_update_tvars(_T26,_T27,_T29,_T2A,0);_T2B=tvtup;_T2C=(unsigned long)_T2B;
if(!_T2C)goto _TL157;
changed=1;_T2D=tvtup;_T2E=*_T2D;{
struct Cyc_List_List*ad=_T2E.f0;_T2F=ad;_T30=(unsigned long)_T2F;
if(!_T30)goto _TL159;
added_tvars=Cyc_List_append(ad,added_tvars);goto _TL15A;_TL159: _TL15A: _T31=tvtup;_T32=*_T31;{
struct Cyc_List_List*rm=_T32.f1;_T33=rm;_T34=(unsigned long)_T33;
if(!_T34)goto _TL15B;
...
# 946
 _TL15D: _T36=removed_tvars;_T37=(unsigned long)_T36;if(_T37)goto _TL15E;else{goto _TL15F;}
...
# 956
removed_tvars=_T4A->tl;}goto _TL15D;_TL15F: _T4B=added_tvars;_T4C=(unsigned long)_T4B;
# 958
...
struct Cyc_Absyn_Decl*ovd=Cyc_Absyn_lookup_decl(tv_ovrs,name);_T5F=ovd;_T60=(unsigned long)_T5F;
if(!_T60)goto _TL172;
changed=1;_T61=ovd;{
...
_TL176: _T65=tvs;_T66=(unsigned long)_T65;if(_T66)goto _TL177;else{goto _TL178;}
...
return _T88;}
# 1028
static void Cyc_Cifc_i_clear_vartype_ids(void*t){void*_T0;int*_T1;unsigned _T2;void*_T3;struct Cyc_Absyn_Tvar*_T4;void*_T5;struct Cyc_List_List*_T6;unsigned long _T7;struct Cyc_List_List*_T8;void*_T9;struct Cyc_List_List*_TA;void*_TB;struct Cyc_Absyn_PtrInfo _TC;void*_TD;void*_TE;struct Cyc_Absyn_ArrayInfo _TF;void*_T10;void*_T11;struct Cyc_Absyn_FnInfo _T12;void*_T13;struct Cyc_Absyn_FnInfo _T14;struct Cyc_List_List*_T15;unsigned long _T16;struct Cyc_List_List*_T17;void*_T18;struct Cyc_List_List*_T19;void*_T1A;void*_T1B;struct Cyc_List_List*_T1C;unsigned long _T1D;struct Cyc_List_List*_T1E;void*_T1F;struct Cyc_List_List*_T20;struct Cyc_Absyn_FnInfo _T21;struct Cyc_Absyn_ArrayInfo _T22;struct Cyc_Absyn_PtrInfo _T23;struct Cyc_List_List*_T24;void*_T25;_T0=t;_T1=(int*)_T0;_T2=*_T1;switch(_T2){case 2: _T3=t;{struct Cyc_Absyn_VarType_Absyn_Type_struct*_T26=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_T3;_T25=_T26->f1;}{struct Cyc_Absyn_Tvar*tv=_T25;_T4=tv;
# 1031
...
# 1034
_TL17F: _T6=ts;_T7=(unsigned long)_T6;if(_T7)goto _TL180;else{goto _TL181;}
...
_TL182: _T15=argit;_T16=(unsigned long)_T15;if(_T16)goto _TL183;else{goto _TL184;}
...
# 1058
_TL185: _T1C=ts;_T1D=(unsigned long)_T1C;if(_T1D)goto _TL186;else{goto _TL187;}
...
# 1071
static void Cyc_Cifc_clear_vartype_ids(struct Cyc_Absyn_Decl*d){struct Cyc_Absyn_Decl*_T0;int*_T1;unsigned _T2;struct Cyc_Absyn_Vardecl*_T3;void*_T4;struct Cyc_Absyn_Fndecl*_T5;struct Cyc_Absyn_FnInfo _T6;void*_T7;struct Cyc_Absyn_Fndecl*_T8;struct Cyc_Absyn_FnInfo _T9;struct Cyc_List_List*_TA;unsigned long _TB;struct Cyc_List_List*_TC;void*_TD;struct _tuple8*_TE;struct _tuple8 _TF;void*_T10;struct Cyc_Absyn_Fndecl*_T11;_T0=d;{
...
_TL189: _TA=ai;_TB=(unsigned long)_TA;if(_TB)goto _TL18A;else{goto _TL18B;}
...
# 1103
void Cyc_Cifc_user_overrides(unsigned loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List**ds,struct Cyc_List_List*ovrs){struct Cyc_List_List*_T0;void*_T1;struct _fat_ptr*_T2;unsigned long _T3;struct Cyc_Absyn_Decl*_T4;unsigned _T5;struct _fat_ptr _T6;struct _fat_ptr _T7;struct Cyc_List_List**_T8;struct Cyc_List_List*_T9;struct _fat_ptr*_TA;struct Cyc_Absyn_Decl*_TB;unsigned long _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct _fat_ptr*_TE;struct Cyc_Absyn_Decl*_TF;unsigned _T10;struct _fat_ptr _T11;struct _fat_ptr _T12;struct Cyc_List_List*_T13;int _T14;int _T15;struct Cyc_List_List*_T16;struct Cyc_List_List*_T17;struct Cyc_List_List*_T18;struct Cyc_List_List*(*_T19)(int(*)(struct Cyc_List_List*,struct Cyc_Absyn_Decl*),struct Cyc_List_List*,struct Cyc_List_List*);struct Cyc_List_List*(*_T1A)(int(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_List_List*_T1B;struct Cyc_List_List**_T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*_T1E;struct Cyc_List_List*_T1F;struct Cyc_List_List*_T20;unsigned long _T21;struct Cyc_List_List**_T22;struct Cyc_List_List*_T23;struct Cyc_List_List**_T24;struct Cyc_List_List*_T25;
...
struct _fat_ptr*un=Cyc_Absyn_decl_name(ud);_T2=un;_T3=(unsigned long)_T2;
...
# 1112
_TL190: _T8=_check_null(ds);_T9=*_T8;_TA=un;{struct Cyc_Absyn_Decl*d=Cyc_Cifc_lookup_concrete_decl(_T9,_TA);_TB=d;_TC=(unsigned long)_TB;
...
# 1128
abs_decls=Cyc_List_append(_T1E,_T1F);_T20=abs_decls;_T21=(unsigned long)_T20;
# 1130
