...
# 971
extern void*Cyc_Absyn_char_type;extern void*Cyc_Absyn_ulong_type;
# 973
...
void*_T5=_T0->r;struct Cyc_Absyn_Exp*_T6;_T1=(int*)_T5;_T2=*_T1;if(_T2!=22)goto _TL0;{struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_T7=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_T5;_T6=_T7->f1;}{struct Cyc_Absyn_Exp*e1=_T6;_T3=
...
# 101
static int Cyc_RemoveAggrs_can_use_initializer(struct Cyc_Absyn_Exp*e,void*t){int _T0;struct Cyc_Absyn_Exp*_T1;void*_T2;unsigned long _T3;struct Cyc_Absyn_Exp*_T4;void*_T5;int _T6;struct Cyc_Absyn_Exp*_T7;void*_T8;void*_T9;void*_TA;int _TB;_T1=e;_T2=_T1->topt;_T3=(unsigned long)_T2;
...
unsigned long n=_get_fat_size(_T10,sizeof(char));{
...
# 121
dles=Cyc_List_imp_rev(dles);_T1B=e;{struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_T160=_cycalloc(sizeof(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct));_T160->tag=27;
_T160->f1=dles;_T1C=(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_T160;}_T1B->r=(void*)_T1C;_T1D=
Cyc_RemoveAggrs_remove_aggrs_exp(env,e);return _T1D;}}_TLC: goto _LL0;}_TLA: goto _LL6;case 17: _LL6: goto _LL8;case 21: _LL8: goto _LLA;case 34: _LLA: goto _LLC;case 33: _LLC: goto _LLE;case 41: _LLE: goto _LL10;case 1: _LL10: goto _LL0;case 16:{struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_T160=(struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_T155;_T15E=_T160->f2;}{struct Cyc_Absyn_Exp*e1=_T15E;_T1E=e;{
# 135
...
struct _tuple0**v;_T5D=sdopt;_T5E=(unsigned long)_T5D;
...
_TA0->topt=_TA1->topt;_TL2D: goto _LL0;}}}}case 27:{struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_T160=(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_T155;_T15C=_T160->f1;}{struct Cyc_List_List*dles=_T15C;
# 211
res=0U;
...
Cyc_Absyn_signed_int_exp(i,0U);_TBC=Cyc_Absyn_slong_type;_TBD=Cyc_Absyn_set_type(_TBB,_TBC);_TBE=
# 233
...
_TD3->topt=_TD4->topt;goto _LL0;}}}}case 28:{struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*_T160=(struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_T155;_T15A=_T160->f1;_T15E=_T160->f2;_T159=_T160->f3;_T158=_T160->f4;}{struct Cyc_Absyn_Vardecl*vd=_T15A;struct Cyc_Absyn_Exp*bd=_T15E;struct Cyc_Absyn_Exp*body=_T159;int zero_term=_T158;
# 251
did_assign=1;
res=0U;_TD5=env;{
...
Cyc_Absyn_var_exp(i,0U);_TDC=Cyc_Absyn_slong_type;_TDD=Cyc_Absyn_set_type(_TDB,_TDC);_TDE=
Cyc_Absyn_signed_int_exp(0,0U);_TDF=Cyc_Absyn_slong_type;_TE0=Cyc_Absyn_set_type(_TDE,_TDF);{
# 259
struct Cyc_Absyn_Exp*ea=Cyc_Absyn_assign_exp(_TDD,_TE0,0U);_TE1=
# 261
Cyc_Absyn_var_exp(i,0U);_TE2=Cyc_Absyn_ulong_type;_TE3=Cyc_Absyn_set_type(_TE1,_TE2);_TE4=
Cyc_Absyn_var_exp(max,0U);_TE5=Cyc_Absyn_ulong_type;_TE6=Cyc_Absyn_set_type(_TE4,_TE5);{
# 261
struct Cyc_Absyn_Exp*eb=Cyc_Absyn_lt_exp(_TE3,_TE6,0U);_TE7=
# 263
Cyc_Absyn_var_exp(i,0U);_TE8=Cyc_Absyn_ulong_type;_TE9=Cyc_Absyn_set_type(_TE7,_TE8);{struct Cyc_Absyn_Exp*ec=Cyc_Absyn_increment_exp(_TE9,0U,0U);_TEA=env;_TEB=_TEA.dest;{
...
# 270
Cyc_Absyn_var_exp(i,0U);_TFA=Cyc_Absyn_ulong_type;_TFB=Cyc_Absyn_set_type(_TF9,_TFA);{struct Cyc_Absyn_Exp*lval=Cyc_Absyn_subscript_exp(_TF8,_TFB,0U);
...
Cyc_Absyn_var_exp(max,0U);_T107=Cyc_Absyn_slong_type;_T108=Cyc_Absyn_set_type(_T106,_T107);_T109=
# 281
...
# 287
 Cyc_RemoveAggrs_noarray_remove_aggrs_exp(Cyc_RemoveAggrs_other_env,bd);_T10F=e;_T110=max;_T111=Cyc_Absyn_ulong_type;_T112=bd;_T113=
# 289
Cyc_Absyn_declare_stmt(i,Cyc_Absyn_ulong_type,0,s,0U);_T114=
# 288
Cyc_Absyn_declare_stmt(_T110,_T111,_T112,_T113,0U);_T115=
# 290
Cyc_Absyn_signed_int_exp(0,0U);_T116=Cyc_Absyn_slong_type;_T117=Cyc_Absyn_set_type(_T115,_T116);_T118=Cyc_Absyn_exp_stmt(_T117,0U);_T119=
# 288
Cyc_Absyn_seq_stmt(_T114,_T118,0U);_T11A=Cyc_Absyn_stmt_exp(_T119,0U);_T10F->r=_T11A->r;_T11B=e;
# 291
_T11B->topt=Cyc_Absyn_slong_type;goto _LL0;}}}}}}}}}case 29:{struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_T160=(struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_T155;_T15E=_T160->f1;}{struct Cyc_Absyn_Exp*bd=_T15E;
# 295
did_assign=1;
res=0U;_T11C=env;{
