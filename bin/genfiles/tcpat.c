...
void*t2=Cyc_Absyn_pointer_type(pi);_T74=access_exp;_T75=(unsigned long)_T74;
if(!_T75)goto _TL67;
...
struct Cyc_Absyn_Exp*new_access_exp=0;_TAA=access_exp;_TAB=(unsigned long)_TAA;
...
t=Cyc_Absyn_pointer_type(pi);}_LL41:;}_TD9=new_access_exp;_TDA=(unsigned long)_TD9;
# 385
...
# 501
struct Cyc_Absyn_Exp*new_access_exp=0;_T1AE=access_exp;_T1AF=(unsigned long)_T1AE;
...
struct Cyc_Absyn_Exp*new_access_exp=0;_T1F5=access_exp;_T1F6=(unsigned long)_T1F5;
...
# 571
void*field_typ=Cyc_Tcutil_substitute(_T23D,_T242);_T243=access_exp;_T244=(unsigned long)_T243;
# 574
...
_TL24C: _TD3=fields;_TD4=(unsigned long)_TD3;if(_TD4)goto _TL24A;else{goto _TL24B;}
...
_TL257: _TF8=fields;_TF9=(unsigned long)_TF8;if(_TF9)goto _TL255;else{goto _TL256;}
