...
return _T13;}}
# 432
struct Cyc_Dict_Dict Cyc_Dict_intersect_c(void*(*f)(void*,void*,void*,void*),void*env,struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2){struct Cyc_Dict_Dict _T0;struct Cyc_Dict_Dict _T1;struct Cyc_Dict_Dict _T2;const struct Cyc_Dict_T*_T3;int _T4;const struct Cyc_Dict_T*_T5;int _T6;struct Cyc_Dict_Dict _T7;const struct Cyc_Dict_T**_T8;const struct Cyc_Dict_T**_T9;struct _RegionHandle*_TA;unsigned long _TB;unsigned long _TC;int _TD;int _TE;struct _fat_ptr _TF;int _T10;int _T11;unsigned char*_T12;const struct Cyc_Dict_T**_T13;struct _tuple0 _T14;void*_T15;struct _tuple0 _T16;void*_T17;int _T18;unsigned long _T19;struct _fat_ptr _T1A;unsigned long _T1B;struct _fat_ptr _T1C;struct _fat_ptr _T1D;unsigned long _T1E;const struct Cyc_Dict_T**_T1F;struct _RegionHandle*_T20;unsigned long _T21;unsigned long _T22;struct _fat_ptr _T23;unsigned long _T24;unsigned long _T25;struct _fat_ptr _T26;unsigned char*_T27;const struct Cyc_Dict_T**_T28;unsigned long _T29;int _T2A;unsigned long _T2B;struct _fat_ptr _T2C;int _T2D;unsigned char*_T2E;const struct Cyc_Dict_T**_T2F;struct _fat_ptr _T30;int _T31;unsigned char*_T32;const struct Cyc_Dict_T**_T33;int _T34;struct Cyc_Dict_Dict _T35;struct _RegionHandle*_T36;struct Cyc_Dict_Dict _T37;int(*_T38)(void*,void*);struct _tuple0 _T39;void*_T3A;void*_T3B;void*_T3C;void*_T3D;const struct Cyc_Dict_T*_T3E;struct Cyc_Dict_Dict _T3F;struct Cyc_Dict_Dict _T40;struct Cyc_Dict_Dict _T41;_T0=d2;{
# 435
...
const struct Cyc_Dict_T*ans_tree=0;struct _RegionHandle _T42=_new_region(0U,"temp");struct _RegionHandle*temp=& _T42;_push_region(temp);{unsigned long _T43=16U;_TA=temp;_TB=_check_times(_T43,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_T44=_region_malloc(_TA,0U,_TB);{unsigned long _T45=_T43;unsigned long i;i=0;_TLF0: if(i < _T45)goto _TLEE;else{goto _TLEF;}_TLEE: _TC=i;
# 441
...
_TLF2: _TF=queue;_T10=ind;ind=_T10 + -1;_T11=_T10;_T12=_check_fat_subscript(_TF,sizeof(const struct Cyc_Dict_T*),_T11);_T13=(const struct Cyc_Dict_T**)_T12;{const struct Cyc_Dict_T*_T43=*_T13;void*_T44;void*_T45;const struct Cyc_Dict_T*_T46;const struct Cyc_Dict_T*_T47;{struct Cyc_Dict_T _T48=*_T43;_T47=_T48.left;_T46=_T48.right;_T14=_T48.key_val;_T15=_T14.f0;_T45=(void*)_T15;_T16=_T48.key_val;_T17=_T16.f1;_T44=(void*)_T17;}{const struct Cyc_Dict_T*l=_T47;const struct Cyc_Dict_T*r=_T46;void*k=_T45;void*v=_T44;_T18=ind + 2;_T19=(unsigned long)_T18;_T1A=queue;_T1B=
_get_fat_size(_T1A,sizeof(const struct Cyc_Dict_T*));if(_T19 < _T1B)goto _TLF4;_T1D=queue;_T1E=
_get_fat_size(_T1D,sizeof(const struct Cyc_Dict_T*));{unsigned long _T48=_T1E * 2U;_T20=temp;_T21=_check_times(_T48,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_T49=_region_malloc(_T20,0U,_T21);{unsigned long _T4A=_T48;unsigned long i;i=0;_TLF9: if(i < _T4A)goto _TLF7;else{goto _TLF8;}_TLF7: _T22=i;_T23=queue;_T24=
_get_fat_size(_T23,sizeof(const struct Cyc_Dict_T*));if(_T22 >= _T24)goto _TLFA;_T25=i;_T26=queue;_T27=_T26.curr;_T28=(const struct Cyc_Dict_T**)_T27;_T29=i;_T2A=(int)_T29;_T49[_T25]=_T28[_T2A];goto _TLFB;_TLFA: _T2B=i;_T49[_T2B]=t2;_TLFB: i=i + 1;goto _TLF9;_TLF8:;}_T1F=(const struct Cyc_Dict_T**)_T49;}_T1C=
# 446
_tag_fat(_T1F,sizeof(const struct Cyc_Dict_T*),_T48);}queue=_T1C;goto _TLF5;_TLF4: _TLF5:
# 448
 if(l==0)goto _TLFC;_T2C=queue;ind=ind + 1;_T2D=ind;_T2E=_check_fat_subscript(_T2C,sizeof(const struct Cyc_Dict_T*),_T2D);_T2F=(const struct Cyc_Dict_T**)_T2E;*_T2F=l;goto _TLFD;_TLFC: _TLFD:
 if(r==0)goto _TLFE;_T30=queue;ind=ind + 1;_T31=ind;_T32=_check_fat_subscript(_T30,sizeof(const struct Cyc_Dict_T*),_T31);_T33=(const struct Cyc_Dict_T**)_T32;*_T33=r;goto _TLFF;_TLFE: _TLFF: _T34=
Cyc_Dict_member(d1,k);if(!_T34)goto _TL100;_T35=d2;_T36=_T35.r;_T37=d2;_T38=_T37.rel;{struct _tuple0 _T48;
_T48.f0=k;_T3A=env;_T3B=k;_T3C=Cyc_Dict_lookup(d1,k);_T3D=v;_T48.f1=f(_T3A,_T3B,_T3C,_T3D);_T39=_T48;}_T3E=ans_tree;ans_tree=Cyc_Dict_ins(_T36,_T38,_T39,_T3E);goto _TL101;_TL100: _TL101:;}}goto _TLF1;_TLF3:;}{struct Cyc_Dict_Dict _T43;_T40=d2;
# 454
...
# 558
int Cyc_Dict_iter_f(struct _tuple10*stk,struct _tuple0*dest){struct _tuple10*_T0;struct _tuple10*_T1;int*_T2;int*_T3;int _T4;int _T5;struct _fat_ptr _T6;int _T7;unsigned char*_T8;const struct Cyc_Dict_T**_T9;struct _tuple0*_TA;const struct Cyc_Dict_T*_TB;const struct Cyc_Dict_T*_TC;const struct Cyc_Dict_T*_TD;unsigned long _TE;struct _fat_ptr _TF;unsigned char*_T10;const struct Cyc_Dict_T**_T11;int _T12;const struct Cyc_Dict_T*_T13;const struct Cyc_Dict_T*_T14;const struct Cyc_Dict_T*_T15;unsigned long _T16;struct _fat_ptr _T17;int _T18;unsigned char*_T19;const struct Cyc_Dict_T**_T1A;const struct Cyc_Dict_T*_T1B;int*_T1C;void*_T1D;struct _fat_ptr _T1E;_T0=stk;{struct _tuple10 _T1F=*_T0;_T1E=_T1F.f0;_T1=stk;_T2=& _T1->f1;_T1D=(int*)_T2;}{struct _fat_ptr stack=_T1E;int*indp=(int*)_T1D;_T3=indp;{
# 562
...
ind=ind + -1;_TC=t;_TD=_TC->left;_TE=(unsigned long)_TD;
if(!_TE)goto _TL10E;_TF=stack;_T10=_TF.curr;_T11=(const struct Cyc_Dict_T**)_T10;
ind=ind + 1;_T12=ind;_T13=t;_T11[_T12]=_T13->left;goto _TL10F;_TL10E: _TL10F: _T14=t;_T15=_T14->right;_T16=(unsigned long)_T15;
...
# 587
t=_T2.t;_T4=2 * half_max_size;{unsigned long _TE=(unsigned long)_T4;_T6=rgn;_T7=_check_times(_TE,sizeof(const struct Cyc_Dict_T*));{const struct Cyc_Dict_T**_TF=_region_malloc(_T6,0U,_T7);{unsigned long _T10=_TE;unsigned long i;i=0;_TL118: if(i < _T10)goto _TL116;else{goto _TL117;}_TL116: _T8=i;
_TF[_T8]=t;i=i + 1;goto _TL118;_TL117:;}_T5=(const struct Cyc_Dict_T**)_TF;}_T3=_tag_fat(_T5,sizeof(const struct Cyc_Dict_T*),_TE);}{struct _fat_ptr stack=_T3;{struct Cyc_Iter_Iter _TE;_TB=rgn;{struct _tuple10*_TF=_region_malloc(_TB,0U,sizeof(struct _tuple10));
_TF->f0=stack;_TC=t;_TD=(unsigned long)_TC;if(!_TD)goto _TL119;_TF->f1=0;goto _TL11A;_TL119: _TF->f1=- 1;_TL11A: _TA=(struct _tuple10*)_TF;}_TE.env=_TA;
_TE.next=Cyc_Dict_iter_f;_T9=_TE;}
# 589
return _T9;}}}
# 597
