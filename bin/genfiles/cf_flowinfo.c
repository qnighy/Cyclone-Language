...
# 89
int Cyc_CfFlowInfo_get_field_index_fs(struct Cyc_List_List*fs,struct _fat_ptr*f){struct Cyc_List_List*_T0;unsigned long _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_Absyn_Aggrfield*_T4;int _T5;int _T6;struct Cyc_List_List*_T7;struct Cyc_String_pa_PrintArg_struct _T8;struct _fat_ptr*_T9;int(*_TA)(struct _fat_ptr,struct _fat_ptr);void*(*_TB)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _TC;struct _fat_ptr _TD;
int n=0;
_TL7: _T0=fs;_T1=(unsigned long)_T0;if(_T1)goto _TL5;else{goto _TL6;}
...
# 167
struct _fat_ptr Cyc_CfFlowInfo_aggrfields_to_aggrdict(struct Cyc_CfFlowInfo_FlowEnv*fenv,struct Cyc_List_List*fs,int no_init_bits_only,void*leafval){int _T0;struct _fat_ptr _T1;void**_T2;unsigned long _T3;unsigned long _T4;struct Cyc_CfFlowInfo_FlowEnv*_T5;int _T6;unsigned _T7;unsigned _T8;struct Cyc_List_List*_T9;void*_TA;struct _fat_ptr*_TB;struct _fat_ptr _TC;unsigned long _TD;struct _fat_ptr _TE;unsigned char*_TF;void**_T10;int _T11;struct Cyc_List_List*_T12;struct _fat_ptr _T13;_T0=
# 173
Cyc_List_length(fs);{unsigned sz=(unsigned)_T0;{unsigned long _T14=sz;_T3=_check_times(_T14,sizeof(void*));{void**_T15=_cycalloc(_T3);{unsigned long _T16=_T14;unsigned long i;i=0;_TL2C: if(i < _T16)goto _TL2A;else{goto _TL2B;}_TL2A: _T4=i;_T5=fenv;
...
Cyc_List_length(tqts);_T19=_T18 + 1;{unsigned sz=(unsigned)_T19;{unsigned long _T74=sz;_T1C=_check_times(_T74,sizeof(void*));{void**_T75=_cycalloc(_T1C);{unsigned long _T76=_T74;unsigned long i;i=0;_TL48: if(i < _T76)goto _TL46;else{goto _TL47;}_TL46: _T1D=i;_T1E=fenv;
...
_TL67: _TC=d;{unsigned long sz=_get_fat_size(_TC,sizeof(void*));{
int i=0;_TL6C: _TD=i;_TE=(unsigned long)_TD;_TF=sz;if(_TE < _TF)goto _TL6A;else{goto _TL6B;}
...
# 328
unsigned long sz=_get_fat_size(_T7,sizeof(void*));
int change=0;{unsigned long _T3B=sz;_TA=_check_times(_T3B,sizeof(void*));{void**_T3C=_cycalloc(_TA);{unsigned long _T3D=_T3B;unsigned long i;i=0;_TL73: if(i < _T3D)goto _TL71;else{goto _TL72;}_TL71: _TB=i;_TC=d;_TD=_TC.curr;_TE=(void**)_TD;_TF=
...
int i=0;_TL77: _T12=i;_T13=(unsigned long)_T12;_T14=sz;if(_T13 < _T14)goto _TL75;else{goto _TL76;}
...
# 415
int i=0;_TLAC: _T9=i;_TA=(unsigned long)_T9;_TB=d;_TC=_get_fat_size(_TB,sizeof(void*));if(_TA < _TC)goto _TLAA;else{goto _TLAB;}
...
return;}default:
 return;};}
# 425
static void*Cyc_CfFlowInfo_insert_place_inner(void*new_val,void*old_val){void*_T0;int*_T1;unsigned _T2;void*_T3;struct Cyc_CfFlowInfo_UnionRInfo _T4;struct _fat_ptr _T5;struct _fat_ptr _T6;void**_T7;unsigned long _T8;unsigned long _T9;void*_TA;struct _fat_ptr _TB;unsigned char*_TC;void**_TD;void**_TE;unsigned long _TF;int _T10;void*_T11;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_T12;void*_T13;void*_T14;void*_T15;struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_T16;void*_T17;void*_T18;void*_T19;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_T1A;void*_T1B;void*_T1C;struct Cyc_Absyn_Vardecl*_T1D;int _T1E;void*_T1F;void*_T20;struct _fat_ptr _T21;int _T22;_T0=old_val;_T1=(int*)_T0;_T2=*_T1;switch(_T2){case 6: _T3=old_val;{struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_T23=(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_T3;_T4=_T23->f1;_T22=_T4.is_union;_T21=_T23->f2;}{int is_union=_T22;struct _fat_ptr d=_T21;_T6=d;{unsigned long _T23=
# 428
_get_fat_size(_T6,sizeof(void*));_T8=_check_times(_T23,sizeof(void*));{void**_T24=_cycalloc(_T8);{unsigned long _T25=_T23;unsigned long i;i=0;_TLB1: if(i < _T25)goto _TLAF;else{goto _TLB0;}_TLAF: _T9=i;_TA=new_val;_TB=d;_TC=_TB.curr;_TD=(void**)_TC;_TE=
...
return _T1C;};}
# 443
static struct _fat_ptr Cyc_CfFlowInfo_aggr_dict_insert(struct _fat_ptr d,int n,void*rval){struct _fat_ptr _T0;int _T1;unsigned char*_T2;void**_T3;struct _fat_ptr _T4;struct _fat_ptr _T5;struct _fat_ptr _T6;void**_T7;unsigned long _T8;unsigned long _T9;struct _fat_ptr _TA;unsigned char*_TB;void**_TC;unsigned long _TD;int _TE;struct _fat_ptr _TF;unsigned char*_T10;void**_T11;int _T12;struct _fat_ptr _T13;_T0=d;_T1=n;_T2=_check_fat_subscript(_T0,sizeof(void*),_T1);_T3=(void**)_T2;{
void*old_rval=*_T3;
if(old_rval!=rval)goto _TLB2;_T4=d;return _T4;_TLB2: _T6=d;{unsigned long _T14=
_get_fat_size(_T6,sizeof(void*));_T8=_check_times(_T14,sizeof(void*));{void**_T15=_cycalloc(_T8);{unsigned long _T16=_T14;unsigned long i;i=0;_TLB7: if(i < _T16)goto _TLB5;else{goto _TLB6;}_TLB5: _T9=i;_TA=d;_TB=_TA.curr;_TC=(void**)_TB;_TD=i;_TE=(int)_TD;_T15[_T9]=_TC[_TE];i=i + 1;goto _TLB7;_TLB6:;}_T7=(void**)_T15;}_T5=_tag_fat(_T7,sizeof(void*),_T14);}{struct _fat_ptr res=_T5;_TF=res;_T10=_TF.curr;_T11=(void**)_T10;_T12=n;
...
# 531
unsigned long sz=_get_fat_size(_TC,sizeof(void*));
this_ans=0U;_TD=f;_TE=- 1;
if(_TD!=_TE)goto _TLDA;{
int i=0;_TLDF: _TF=i;_T10=(unsigned long)_TF;_T11=sz;if(_T10 < _T11)goto _TLDD;else{goto _TLDE;}
...
# 543
unsigned long sz=_get_fat_size(_T24,sizeof(void*));
this_ans=1U;{
int i=0;_TLE7: _T25=i;_T26=(unsigned long)_T25;_T27=sz;if(_T26 < _T27)goto _TLE5;else{goto _TLE6;}
...
# 667
_TL114: change=0;{
int i=0;_TL11D: _T51=i;_T52=(unsigned long)_T51;_T53=d1;_T54=_get_fat_size(_T53,sizeof(void*));if(_T52 < _T54)goto _TL11B;else{goto _TL11C;}
...
# 881
int change=0;{
int i=0;_TL18C: _TCE=i;_TCF=(unsigned long)_TCE;_TD0=d1;_TD1=_get_fat_size(_TD0,sizeof(void*));if(_TCF < _TD1)goto _TL18A;else{goto _TL18B;}
...
# 891
_TL18F: change=0;{
int i=0;_TL198: _TE0=i;_TE1=(unsigned long)_TE0;_TE2=d1;_TE3=_get_fat_size(_TE2,sizeof(void*));if(_TE1 < _TE3)goto _TL196;else{goto _TL197;}
...
int i=0;_TL1ED: _T3D=i;_T3E=(unsigned long)_T3D;_T3F=d1;_T40=_get_fat_size(_T3F,sizeof(void*));if(_T3E < _T40)goto _TL1EB;else{goto _TL1EC;}
...
int i=0;_TL220: _T37=i;_T38=(unsigned long)_T37;_T39=d;_T3A=_get_fat_size(_T39,sizeof(void*));if(_T38 < _T3A)goto _TL21E;else{goto _TL21F;}
_TL21E: _T3B=d;_T3C=_T3B.curr;_T3D=(void**)_T3C;_T3E=_check_null(_T3D);_T3F=i;_T40=_T3E[_T3F];Cyc_CfFlowInfo_print_absrval(_T40);_T41=i + 1;_T42=(unsigned long)_T41;_T43=d;_T44=
