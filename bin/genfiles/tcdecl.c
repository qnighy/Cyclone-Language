...
_get_fat_size(_T8,sizeof(void*));{unsigned _T17=_T9 + 1U;_TB=_check_times(_T17,sizeof(void*));{void**_T18=_cycalloc(_TB);{unsigned _T19=_T17;unsigned i;i=0;_TL5: if(i < _T19)goto _TL3;else{goto _TL4;}_TL3:
