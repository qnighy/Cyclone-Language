...
void Cyc_Tcdecl_merr(unsigned loc,struct _fat_ptr*msg1,struct _fat_ptr fmt,struct _fat_ptr ap){struct _fat_ptr*_T0;struct _fat_ptr _T1;unsigned long _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct _fat_ptr _T5;struct _fat_ptr _T6;struct _fat_ptr _T7;struct _fat_ptr _T8;unsigned long _T9;void**_TA;unsigned long _TB;unsigned long _TC;struct Cyc_String_pa_PrintArg_struct*_TD;struct _fat_ptr*_TE;struct _fat_ptr _TF;unsigned long _T10;struct _fat_ptr _T11;unsigned char*_T12;void**_T13;void**_T14;unsigned long _T15;int _T16;
# 42
...
_get_fat_size(_T8,sizeof(void*));{unsigned long _T17=_T9 + 1U;_TB=_check_times(_T17,sizeof(void*));{void**_T18=_cycalloc(_TB);{unsigned long _T19=_T17;unsigned long i;i=0;_TL5: if(i < _T19)goto _TL3;else{goto _TL4;}_TL3:
 if(i!=0U)goto _TL6;_TC=i;{struct Cyc_String_pa_PrintArg_struct*_T1A=_cycalloc(sizeof(struct Cyc_String_pa_PrintArg_struct));_T1A->tag=0;_TE=msg1;_TF=*_TE;_T1A->f1=_TF;_TD=(struct Cyc_String_pa_PrintArg_struct*)_T1A;}_T18[_TC]=(void*)_TD;goto _TL7;_TL6: _T10=i;_T11=ap;_T12=_T11.curr;_T13=(void**)_T12;_T14=_check_null(_T13);_T15=i - 1U;_T16=(int)_T15;_T18[_T10]=_T14[_T16];_TL7: i=i + 1;goto _TL5;_TL4:;}_TA=(void**)_T18;}_T7=
# 47
