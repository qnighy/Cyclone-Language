...
# 39
struct _fat_ptr Cyc_Filename_chop_extension(struct _fat_ptr filename){struct _fat_ptr _T0;unsigned long _T1;unsigned long _T2;struct _fat_ptr _T3;int _T4;unsigned char*_T5;const char*_T6;char _T7;int _T8;struct Cyc_Core_Invalid_argument_exn_struct*_T9;void*_TA;struct _fat_ptr _TB;int _TC;unsigned long _TD;struct _fat_ptr _TE;_T0=filename;_T1=
...
# 50
struct _fat_ptr Cyc_Filename_dirname(struct _fat_ptr filename){struct _fat_ptr _T0;unsigned long _T1;unsigned long _T2;struct _fat_ptr _T3;int _T4;unsigned char*_T5;const char*_T6;char _T7;int _T8;struct _fat_ptr _T9;struct _fat_ptr _TA;int _TB;unsigned long _TC;struct _fat_ptr _TD;_T0=filename;_T1=
_get_fat_size(_T0,sizeof(char));_T2=_T1 - 1U;{int i=(int)_T2;
...
# 59
struct _fat_ptr Cyc_Filename_basename(struct _fat_ptr filename){struct _fat_ptr _T0;unsigned long _T1;unsigned long _T2;struct _fat_ptr _T3;int _T4;unsigned char*_T5;const char*_T6;char _T7;int _T8;struct _fat_ptr _T9;int _TA;struct _fat_ptr _TB;unsigned long _TC;int _TD;unsigned long _TE;unsigned long _TF;struct _fat_ptr _T10;_T0=filename;_T1=
_get_fat_size(_T0,sizeof(char));_T2=_T1 - 1U;{int i=(int)_T2;
...
_TL11: _T6=filename;_T7=i;i=_T7 + -1;_T8=_T7;_T9=_check_fat_subscript(_T6,sizeof(char),_T8);_TA=(const char*)_T9;_TB=*_TA;_TC=(int)_TB;_TD=suffix;_TE=j;j=_TE + -1;_TF=_TE;_T10=_check_fat_subscript(_TD,sizeof(char),_TF);_T11=(const char*)_T10;_T12=*_T11;_T13=(int)_T12;if(_TC==_T13)goto _TL14;return 0;_TL14: goto _TL10;_TL12:
 ...
 return 1;}}}
# 75
struct _fat_ptr Cyc_Filename_gnuify(struct _fat_ptr filename){int _T0;struct _fat_ptr _T1;unsigned long _T2;struct _fat_ptr _T3;unsigned char*_T4;const char*_T5;const char*_T6;char _T7;int _T8;int _T9;struct _fat_ptr _TA;unsigned long _TB;unsigned long _TC;struct _fat_ptr _TD;int _TE;unsigned long _TF;char*_T10;unsigned long _T11;unsigned long _T12;struct _fat_ptr _T13;unsigned char*_T14;char*_T15;char _T16;struct _fat_ptr _T17;unsigned char*_T18;char*_T19;unsigned long _T1A;unsigned char*_T1B;char*_T1C;unsigned long _T1D;unsigned char*_T1E;char*_T1F;struct _fat_ptr _T20;unsigned char*_T21;char*_T22;struct _fat_ptr _T23;unsigned char*_T24;const char*_T25;const char*_T26;unsigned long _T27;unsigned char*_T28;char*_T29;struct _fat_ptr _T2A;unsigned long _T2B;struct _fat_ptr _T2C;int _T2D;unsigned long _T2E;char*_T2F;unsigned long _T30;unsigned long _T31;struct _fat_ptr _T32;int _T33;int _T34;unsigned char*_T35;const char*_T36;struct _fat_ptr _T37;int _T38;int _T39;unsigned char*_T3A;char*_T3B;char _T3C;char _T3D;int _T3E;unsigned long _T3F;unsigned char*_T40;char*_T41;struct _fat_ptr _T42;_T1=filename;_T2=
...
_get_fat_size(_TA,sizeof(char));_TC=_TB + 1U;ans_sz=(int)_TC;_TE=ans_sz;_TF=(unsigned long)_TE;{unsigned long _T43=_TF + 1U;_T11=_check_times(_T43,sizeof(char));{char*_T44=_cycalloc_atomic(_T11);{unsigned long _T45=_T43;unsigned long k;k=0;_TL1F: if(k < _T45)goto _TL1D;else{goto _TL1E;}_TL1D: _T12=k;
...
j=2;goto _TL1B;
# 88
_TL1A: _T2A=filename;_T2B=_get_fat_size(_T2A,sizeof(char));ans_sz=(int)_T2B;_T2D=ans_sz;_T2E=(unsigned long)_T2D;{unsigned long _T43=_T2E + 1U;_T30=_check_times(_T43,sizeof(char));{char*_T44=_cycalloc_atomic(_T30);{unsigned long _T45=_T43;unsigned long k;k=0;_TL29: if(k < _T45)goto _TL27;else{goto _TL28;}_TL27: _T31=k;
