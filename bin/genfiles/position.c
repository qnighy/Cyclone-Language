...
# 111
struct _fat_ptr Cyc_Position_get_line_directive(unsigned s){struct _fat_ptr _T0;unsigned char*_T1;unsigned long _T2;struct _fat_ptr _T3;unsigned _T4;int _T5;struct _fat_ptr _T6;struct Cyc_Int_pa_PrintArg_struct _T7;struct Cyc_Lineno_Pos*_T8;int _T9;struct Cyc_String_pa_PrintArg_struct _TA;struct Cyc_Lineno_Pos*_TB;struct _fat_ptr _TC;struct _fat_ptr _TD;struct _fat_ptr _TE;
struct _tuple0 _TF=Cyc_Position_seg_to_loc(s);unsigned _T10;struct _fat_ptr _T11;_T11=_TF.f0;_T10=_TF.f1;{struct _fat_ptr source=_T11;unsigned loc=_T10;_T0=source;_T1=_T0.curr;_T2=(unsigned long)_T1;
