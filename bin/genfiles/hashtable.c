...
# 53
_T5->r=r;_T5->cmp=cmp;_T5->hash=hash;_T5->max_len=3;{unsigned long _T6=sz;_T3=r;_T4=_region_calloc(_T3,0U,sizeof(struct Cyc_Hashtable_Bucket),_T6);_T2=_tag_fat(_T4,sizeof(struct Cyc_Hashtable_Bucket),_T6);}_T5->tab=_T2;_T0=(struct Cyc_Hashtable_Table*)_T5;}return _T0;}
# 56
...
# 60
void Cyc_Hashtable_insert(struct Cyc_Hashtable_Table*t,void*key,void*val){struct Cyc_Hashtable_Table*_T0;struct Cyc_Hashtable_Table*_T1;int(*_T2)(void*);int _T3;unsigned long _T4;struct _fat_ptr _T5;unsigned long _T6;struct _fat_ptr _T7;unsigned _T8;int _T9;struct _fat_ptr _TA;unsigned char*_TB;unsigned char*_TC;struct Cyc_Hashtable_Bucket*_TD;struct Cyc_Hashtable_Cell*_TE;struct Cyc_Hashtable_Table*_TF;struct _RegionHandle*_T10;struct Cyc_Hashtable_Bucket*_T11;struct Cyc_Hashtable_Bucket*_T12;unsigned _T13;struct Cyc_Hashtable_Bucket*_T14;unsigned _T15;struct Cyc_Hashtable_Table*_T16;int _T17;unsigned _T18;_T0=t;{
struct _fat_ptr tab=_T0->tab;_T1=t;_T2=_T1->hash;_T3=
_T2(key);_T4=(unsigned long)_T3;_T5=tab;_T6=_get_fat_size(_T5,sizeof(struct Cyc_Hashtable_Bucket));{unsigned bucket=_T4 % _T6;_T7=tab;_T8=bucket;_T9=(int)_T8;_TA=
...
# 73
void*Cyc_Hashtable_lookup(struct Cyc_Hashtable_Table*t,void*key){struct Cyc_Hashtable_Table*_T0;struct Cyc_Hashtable_Table*_T1;struct _fat_ptr _T2;unsigned char*_T3;struct Cyc_Hashtable_Bucket*_T4;struct Cyc_Hashtable_Bucket*_T5;struct Cyc_Hashtable_Table*_T6;int(*_T7)(void*);int _T8;unsigned long _T9;struct _fat_ptr _TA;unsigned long _TB;unsigned long _TC;int _TD;struct Cyc_Hashtable_Bucket _TE;struct Cyc_Hashtable_Cell*_TF;void*_T10;void*_T11;int _T12;struct Cyc_Hashtable_Cell*_T13;void*_T14;struct Cyc_Hashtable_Cell*_T15;struct Cyc_Core_Not_found_exn_struct*_T16;struct Cyc_Core_Not_found_exn_struct*_T17;_T0=t;{
struct _fat_ptr tab=_T0->tab;_T1=t;{
int(*cmp)(void*,void*)=_T1->cmp;_T2=tab;_T3=_T2.curr;_T4=(struct Cyc_Hashtable_Bucket*)_T3;_T5=
_check_null(_T4);_T6=t;_T7=_T6->hash;_T8=_T7(key);_T9=(unsigned long)_T8;_TA=tab;_TB=_get_fat_size(_TA,sizeof(struct Cyc_Hashtable_Bucket));_TC=_T9 % _TB;_TD=(int)_TC;_TE=_T5[_TD];{struct Cyc_Hashtable_Cell*p=_TE.cells;
...
# 83
void**Cyc_Hashtable_lookup_opt(struct Cyc_Hashtable_Table*t,void*key){struct Cyc_Hashtable_Table*_T0;struct Cyc_Hashtable_Table*_T1;struct _fat_ptr _T2;unsigned char*_T3;struct Cyc_Hashtable_Bucket*_T4;struct Cyc_Hashtable_Bucket*_T5;struct Cyc_Hashtable_Table*_T6;int(*_T7)(void*);int _T8;unsigned long _T9;struct _fat_ptr _TA;unsigned long _TB;unsigned long _TC;int _TD;struct Cyc_Hashtable_Bucket _TE;struct Cyc_Hashtable_Cell*_TF;void*_T10;void*_T11;int _T12;struct Cyc_Hashtable_Cell*_T13;void**_T14;struct Cyc_Hashtable_Cell*_T15;_T0=t;{
struct _fat_ptr tab=_T0->tab;_T1=t;{
int(*cmp)(void*,void*)=_T1->cmp;_T2=tab;_T3=_T2.curr;_T4=(struct Cyc_Hashtable_Bucket*)_T3;_T5=
_check_null(_T4);_T6=t;_T7=_T6->hash;_T8=_T7(key);_T9=(unsigned long)_T8;_TA=tab;_TB=_get_fat_size(_TA,sizeof(struct Cyc_Hashtable_Bucket));_TC=_T9 % _TB;_TD=(int)_TC;_TE=_T5[_TD];{struct Cyc_Hashtable_Cell*p=_TE.cells;
...
# 90
 return 0;}}}}
# 94
void**Cyc_Hashtable_lookup_ptr_opt(struct Cyc_Hashtable_Table*t,void*key){struct Cyc_Hashtable_Table*_T0;struct _fat_ptr _T1;unsigned char*_T2;struct Cyc_Hashtable_Bucket*_T3;struct Cyc_Hashtable_Bucket*_T4;struct Cyc_Hashtable_Table*_T5;int(*_T6)(void*);int _T7;unsigned long _T8;struct _fat_ptr _T9;unsigned long _TA;unsigned long _TB;int _TC;struct Cyc_Hashtable_Bucket _TD;struct Cyc_Hashtable_Cell*_TE;void*_TF;int _T10;void*_T11;int _T12;struct Cyc_Hashtable_Cell*_T13;void**_T14;struct Cyc_Hashtable_Cell*_T15;_T0=t;{
struct _fat_ptr tab=_T0->tab;_T1=tab;_T2=_T1.curr;_T3=(struct Cyc_Hashtable_Bucket*)_T2;_T4=
_check_null(_T3);_T5=t;_T6=_T5->hash;_T7=_T6(key);_T8=(unsigned long)_T7;_T9=tab;_TA=_get_fat_size(_T9,sizeof(struct Cyc_Hashtable_Bucket));_TB=_T8 % _TA;_TC=(int)_TB;_TD=_T4[_TC];{struct Cyc_Hashtable_Cell*p=_TD.cells;
...
# 100
 return 0;}}}
# 107
void**Cyc_Hashtable_lookup_other_opt(struct Cyc_Hashtable_Table*t,void*key,int(*cmp)(void*,void*),int(*hash)(void*)){struct Cyc_Hashtable_Table*_T0;struct _fat_ptr _T1;unsigned char*_T2;struct Cyc_Hashtable_Bucket*_T3;struct Cyc_Hashtable_Bucket*_T4;int _T5;unsigned long _T6;struct _fat_ptr _T7;unsigned long _T8;unsigned long _T9;int _TA;struct Cyc_Hashtable_Bucket _TB;void*_TC;struct Cyc_Hashtable_Cell*_TD;void*_TE;int _TF;struct Cyc_Hashtable_Cell*_T10;void**_T11;struct Cyc_Hashtable_Cell*_T12;_T0=t;{
# 109
struct _fat_ptr tab=_T0->tab;_T1=tab;_T2=_T1.curr;_T3=(struct Cyc_Hashtable_Bucket*)_T2;_T4=
_check_null(_T3);_T5=hash(key);_T6=(unsigned long)_T5;_T7=tab;_T8=_get_fat_size(_T7,sizeof(struct Cyc_Hashtable_Bucket));_T9=_T6 % _T8;_TA=(int)_T9;_TB=_T4[_TA];{struct Cyc_Hashtable_Cell*p=_TB.cells;
...
# 128
 return 0;}}}}
# 131
void Cyc_Hashtable_remove(struct Cyc_Hashtable_Table*t,void*key){struct Cyc_Hashtable_Table*_T0;struct Cyc_Hashtable_Table*_T1;struct Cyc_Hashtable_Table*_T2;int(*_T3)(void*);int _T4;unsigned long _T5;struct _fat_ptr _T6;unsigned long _T7;struct _fat_ptr _T8;unsigned _T9;int _TA;struct _fat_ptr _TB;unsigned char*_TC;unsigned char*_TD;struct Cyc_Hashtable_Bucket*_TE;void*_TF;struct Cyc_Hashtable_Cell*_T10;void*_T11;int _T12;struct Cyc_Hashtable_Bucket*_T13;struct Cyc_Hashtable_Cell*_T14;struct Cyc_Hashtable_Bucket*_T15;struct Cyc_Hashtable_Cell*_T16;struct Cyc_Hashtable_Cell*_T17;struct Cyc_Hashtable_Cell*_T18;void*_T19;struct Cyc_Hashtable_Cell*_T1A;void*_T1B;int _T1C;struct Cyc_Hashtable_Cell*_T1D;struct Cyc_Hashtable_Cell*_T1E;struct Cyc_Hashtable_Bucket*_T1F;struct Cyc_Hashtable_Cell*_T20;struct Cyc_Hashtable_Cell*_T21;_T0=t;{
# 134
struct _fat_ptr tab=_T0->tab;_T1=t;{
int(*cmp)(void*,void*)=_T1->cmp;_T2=t;_T3=_T2->hash;_T4=
_T3(key);_T5=(unsigned long)_T4;_T6=tab;_T7=_get_fat_size(_T6,sizeof(struct Cyc_Hashtable_Bucket));{unsigned bucket=_T5 % _T7;_T8=tab;_T9=bucket;_TA=(int)_T9;_TB=
...
# 154
int Cyc_Hashtable_hash_string(struct _fat_ptr s){struct _fat_ptr _T0;unsigned long _T1;unsigned _T2;int _T3;unsigned _T4;int _T5;struct _fat_ptr _T6;unsigned char*_T7;const char*_T8;const char*_T9;unsigned _TA;int _TB;char _TC;int _TD;char _TE;int _TF;int _T10;
# 156
int ans=0;_T0=s;_T1=
...
return _T4;}}}
# 189
static void Cyc_Hashtable_insert_bucket(struct _RegionHandle*r,struct _fat_ptr tab,int(*hash)(void*),struct Cyc_Hashtable_Cell*elems){struct Cyc_Hashtable_Cell*_T0;struct Cyc_Hashtable_Cell*_T1;int _T2;unsigned long _T3;struct _fat_ptr _T4;unsigned long _T5;struct _fat_ptr _T6;unsigned char*_T7;struct Cyc_Hashtable_Bucket*_T8;unsigned _T9;int _TA;struct Cyc_Hashtable_Cell*_TB;struct _RegionHandle*_TC;struct _fat_ptr _TD;unsigned char*_TE;struct Cyc_Hashtable_Bucket*_TF;struct Cyc_Hashtable_Bucket*_T10;unsigned _T11;int _T12;struct Cyc_Hashtable_Bucket _T13;struct _fat_ptr _T14;unsigned char*_T15;struct Cyc_Hashtable_Bucket*_T16;unsigned _T17;int _T18;struct Cyc_Hashtable_Cell*_T19;
# 192
_TL38: if(elems!=0)goto _TL36;else{goto _TL37;}
_TL36: _T0=elems;{void*key=_T0->key;_T1=elems;{
void*val=_T1->value;_T2=
hash(key);_T3=(unsigned long)_T2;_T4=tab;_T5=_get_fat_size(_T4,sizeof(struct Cyc_Hashtable_Bucket));{unsigned nidx=_T3 % _T5;_T6=tab;_T7=_T6.curr;_T8=(struct Cyc_Hashtable_Bucket*)_T7;_T9=nidx;_TA=(int)_T9;_TC=r;{struct Cyc_Hashtable_Cell*_T1A=_region_malloc(_TC,0U,sizeof(struct Cyc_Hashtable_Cell));
...
unsigned nsize=_T2 + 7U;{unsigned long _T1F=nsize;_T4=t;_T5=_T4->r;_T6=_region_calloc(_T5,0U,sizeof(struct Cyc_Hashtable_Bucket),_T1F);_T3=_tag_fat(_T6,sizeof(struct Cyc_Hashtable_Bucket),_T1F);}{
...
# 235
unsigned Cyc_Hashtable_num_buckets(struct Cyc_Hashtable_Table*t){struct Cyc_Hashtable_Table*_T0;struct _fat_ptr _T1;unsigned long _T2;_T0=t;_T1=_T0->tab;_T2=
...
# 257
void Cyc_Hashtable_print_hist(struct Cyc_Hashtable_Table*t){struct Cyc_Hashtable_Table*_T0;struct _fat_ptr _T1;struct _fat_ptr _T2;unsigned*_T3;unsigned long _T4;unsigned long _T5;struct _fat_ptr _T6;unsigned char*_T7;struct Cyc_Hashtable_Bucket*_T8;struct Cyc_Hashtable_Bucket*_T9;unsigned long _TA;int _TB;struct Cyc_Hashtable_Bucket _TC;struct _fat_ptr _TD;unsigned char*_TE;unsigned*_TF;unsigned _T10;int _T11;unsigned _T12;struct Cyc_Int_pa_PrintArg_struct _T13;unsigned _T14;int _T15;struct Cyc_Int_pa_PrintArg_struct _T16;struct _fat_ptr _T17;unsigned char*_T18;unsigned*_T19;unsigned _T1A;int _T1B;unsigned _T1C;int _T1D;struct Cyc_Double_pa_PrintArg_struct _T1E;struct _fat_ptr _T1F;unsigned char*_T20;unsigned*_T21;unsigned _T22;int _T23;unsigned _T24;unsigned _T25;unsigned _T26;unsigned _T27;struct Cyc___cycFILE*_T28;struct _fat_ptr _T29;struct _fat_ptr _T2A;_T0=t;{
struct _fat_ptr odata=_T0->tab;_T1=odata;{
unsigned osize=_get_fat_size(_T1,sizeof(struct Cyc_Hashtable_Bucket));{unsigned long _T2B=osize;_T4=_check_times(_T2B,sizeof(unsigned));{unsigned*_T2C=_cycalloc_atomic(_T4);{unsigned long _T2D=_T2B;unsigned long i;i=0;_TL5E: if(i < _T2D)goto _TL5C;else{goto _TL5D;}_TL5C: _T5=i;_T6=odata;_T7=_T6.curr;_T8=(struct Cyc_Hashtable_Bucket*)_T7;_T9=
