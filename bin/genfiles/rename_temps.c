...
# 36 "rename_temps.cyc"
static int Cyc_RenameTemps_is_temp_var(struct _tuple0*qv){struct _tuple0*_T0;struct _tuple0 _T1;struct _fat_ptr*_T2;int _T3;struct _fat_ptr _T4;unsigned long _T5;struct _fat_ptr _T6;unsigned char*_T7;const char*_T8;const char*_T9;char _TA;int _TB;struct _fat_ptr _TC;unsigned char*_TD;const char*_TE;char _TF;int _T10;struct _fat_ptr _T11;unsigned char*_T12;const char*_T13;char _T14;int _T15;struct _fat_ptr _T16;unsigned char*_T17;const char*_T18;char _T19;int _T1A;_T0=qv;_T1=*_T0;_T2=_T1.f1;{
struct _fat_ptr v=*_T2;_T4=v;_T5=
_get_fat_size(_T4,sizeof(char));if(_T5 <= 4U)goto _TL0;_T6=v;_T7=_T6.curr;_T8=(const char*)_T7;_T9=
_check_null(_T8);_TA=_T9[0];_TB=(int)_TA;
# 38
if(_TB!=95)goto _TL0;_TC=v;_TD=_TC.curr;_TE=(const char*)_TD;_TF=_TE[1];_T10=(int)_TF;if(_T10!=116)goto _TL0;_T11=v;_T12=_T11.curr;_T13=(const char*)_T12;_T14=_T13[2];_T15=(int)_T14;if(_T15!=109)goto _TL0;_T16=v;_T17=_T16.curr;_T18=(const char*)_T17;_T19=_T18[3];_T1A=(int)_T19;_T3=_T1A==112;goto _TL1;_TL0: _T3=0;_TL1: return _T3;}}
# 41
...
*_T39=vd2;_T18=(struct Cyc_Absyn_Vardecl*)_T39;}_T38->f1=_T18;_T17=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T38;}_T16->r=(void*)_T17;}}goto _TL15;_TL14: _TL15: _T19=vd;_T1A=_T19->initializer;_T1B=(unsigned long)_T1A;
# 92
...
*_T2C=vd2;_T1A=(struct Cyc_Absyn_Vardecl*)_T2C;}_T2B->f1=_T1A;_T19=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T2B;}_T18->r=(void*)_T19;}}goto _TL24;_TL23: _TL24: _T1B=vd;_T1C=_T1B->initializer;_T1D=(unsigned long)_T1C;
# 143
